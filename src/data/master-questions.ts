...
export const masterQuestions: Question[] = [
  ...
  },
  {
    id: "Q_J_126",
    category_id: "journal",
    question_text: "売掛金30,000円の代金として約束手形を受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"受取手形","debit_amount":30000,"credit_account":"売掛金","credit_amount":30000}}',
    explanation:
      "【基本概念】\n売掛金の回収手段として約束手形を受け取る取引です。売掛金（資産）から受取手形（資産）への変換で、資産の質が変化します。\n\n【具体例・イメージ】\n掛け売りした商品代金を現金ではなく約束手形で回収する場面をイメージしてください。「ツケ」を「手形」に変更したことで、確実性が高まります。\n\n【仕訳パターン】\n・約束手形受取: 借方に受取手形、貸方に売掛金\n・手形期日回収: 借方に現金、貸方に受取手形\n・手形割引: 借方に現金+手形売却損、貸方に受取手形\n\n【間違えやすいポイント】\n・受取手形と支払手形を混同する\n・売掛金を借方に記入してしまう\n・手形と現金回収を同時に行うと誤解する\n・約束手形と為替手形の区別\n\n【覚え方のコツ】\n・「受取」手形＝お金をもらう権利（資産）\n・売掛金から受取手形への「振替」\n・回収の「確実性向上」が目的\n・手形は「確定日払い」の約束\n\n【この問題の仕訳】\n売掛金30,000円の代金として約束手形を受け取ったため、受取手形30,000円の増加（借方）と売掛金30,000円の減少（貸方）を記録します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"lending_borrowing","pattern":"貸借取引","subpattern":"売掛金の手形決済・債権移転","accounts":["受取手形","売掛金"],"keywords":["受取手形","約束手形","売掛金","貸借取引","債権移転"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-19T06:30:10.166Z",
  },
  {
    id: "Q_J_127",
    category_id: "journal",
    question_text: "買掛金25,000円の支払いのため約束手形を振り出した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":25000,"credit_account":"支払手形","credit_amount":25000}}',
    explanation:
      "【基本概念】\n買掛金の支払手段として約束手形を振り出す取引です。買掛金（負債）から支払手形（負債）への変換で、支払義務の期限が延長されます。\n\n【具体例・イメージ】\n掛け仕入れした商品代金を現金ではなく約束手形で支払う場面をイメージしてください。「ツケ」を「手形での約束支払」に変更し、支払期限を延ばします。\n\n【仕訳パターン】\n・約束手形振出: 借方に買掛金、貸方に支払手形\n・手形期日決済: 借方に支払手形、貸方に現金\n・手形不渡り: 借方に不渡手形、貸方に支払手形\n\n【間違えやすいポイント】\n・受取手形と支払手形を混同する\n・支払手形を借方に記入してしまう\n・手形と現金支払を同時に行うと誤解する\n・振出と受取の処理を逆にする\n\n【覚え方のコツ】\n・「支払」手形＝お金を払う義務（負債）\n・買掛金から支払手形への「振替」\n・支払の「期限延長」が目的\n・手形は「確定日払い」の約束\n\n【この問題の仕訳】\n買掛金25,000円の支払いのため約束手形を振り出したため、買掛金25,000円の減少（借方）と支払手形25,000円の増加（貸方）を記録します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"lending_borrowing","pattern":"貸借取引","subpattern":"買掛金の手形決済・債務移転","accounts":["買掛金","支払手形"],"keywords":["支払手形","約束手形","買掛金","貸借取引","債務移転"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    id: "Q_J_128",
    category_id: "journal",
    question_text: "売掛金40,000円を現金で回収した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":40000,"credit_account":"売掛金","credit_amount":40000}}',
    explanation:
      "【基本概念】\n売掛金の現金回収は、債権の実現により資産の質が変化する取引です。売掛金（将来の現金受取権）から現金（即座に利用可能）への変換です。\n\n【具体例・イメージ】\n掛け売りした商品代金を顧客から現金で受け取る場面をイメージしてください。「将来もらえる権利」が「実際のお金」になります。\n\n【仕訳パターン】\n・現金回収: 借方に現金、貸方に売掛金\n・振込回収: 借方に普通預金、貸方に売掛金\n・手形回収: 借方に受取手形、貸方に売掛金\n・小切手回収: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金と買掛金を混同する\n・回収時に売掛金を借方に記入してしまう\n・現金以外の回収手段を現金と誤解する\n・一部回収時の金額を間違える\n\n【覚え方のコツ】\n・「回収」＝債権の実現\n・現金増加（借方）、売掛金減少（貸方）\n・「権利」から「実物」への変化\n・売掛金は「減る」のが正常\n\n【この問題の仕訳】\n売掛金40,000円を現金で回収したため、現金40,000円の増加（借方）と売掛金40,000円の減少（貸方）を記録します。",
    difficulty: 1,
    tags_json:
      '{"subcategory":"lending_borrowing","pattern":"貸借取引","subpattern":"売掛金の現金回収・債権実現","accounts":["現金","売掛金"],"keywords":["売掛金回収","現金回収","債権実現","貸借取引"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
