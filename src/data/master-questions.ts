...
export const masterQuestions: Question[] = [
  ...
  },
  {
    id: "Q_J_002",
    category_id: "journal",
    question_text: "小口現金係に500円を前渡しした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
  ...
  },
  {
    id: "Q_J_003",
    category_id: "journal",
    question_text: "売掛金500円が当座預金口座に振り込まれた。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "当座預金残高が不足したため、買掛金100円の支払いで当座借越となった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":100,"credit_account":"当座借越","credit_amount":100}}',
    explanation:
      "【基本概念】\n銀行に開設した決済専用の預金口座で、小切手や手形の決済に使用されます。利息は付きません。\n\n【具体例・イメージ】\n法人が開設する専用の銀行口座で、小切手を振り出したり、取引先からの振込を受けたりする口座をイメージしてください。\n\n【仕訳パターン】\n・入金時: 借方に当座預金、貸方に売掛金等\n・支払時: 借方に買掛金等、貸方に当座預金\n\n【間違えやすいポイント】\n・普通預金と当座預金を混同しやすい\n・他人振出小切手は「現金」として扱う\n・当座借越の処理方法\n\n【覚え方のコツ】\n・「当座」= その場での決済用\n・小切手 = 当座預金から支払う\n・入金で当座預金増加（借方）\n\n【この問題の仕訳】\n借方：買掛金 100円\n貸方：当座借越 100円",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_006",
    category_id: "journal",
    question_text: "小口現金係に250円を前渡しした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"小口現金","debit_amount":250,"credit_account":"現金","credit_amount":250}}',
    explanation:
      "【基本概念】\n日常の少額支払いに備えて、担当者に前渡しする現金です。定額資金前渡制度（インプレスト・システム）で管理されます。\n\n【具体例・イメージ】\n会社の事務用品購入や交通費支払いのために、経理担当者が一定額の現金を机の引き出しに保管している状況をイメージしてください。\n\n【仕訳パターン】\n・前渡し時: 借方に小口現金、貸方に現金\n・補給時: 借方に各種費用、貸方に小口現金（使用分のみ）\n\n【間違えやすいポイント】\n・「前渡し」と「補給」の処理を混同しやすい\n・補給時は使用した金額分だけを処理する\n・小口現金は資産勘定で、常に一定額を保持する\n\n【覚え方のコツ】\n・「小口現金を渡す」→「小口現金が増える（借方）」\n・「小さな支払い用の現金」→「小口現金」\n・定額制なので、使った分だけ補給する\n\n【この問題の仕訳】\n借方：小口現金 250円\n貸方：現金 250円",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_007",
    category_id: "journal",
    question_text: "売掛金250円が当座預金口座に振り込まれた。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"当座預金","debit_amount":250,"credit_account":"売掛金","credit_amount":250}}',
    explanation:
      "【基本概念】\n銀行に開設した決済専用の預金口座で、小切手や手形の決済に使用されます。利息は付きません。\n\n【具体例・イメージ】\n法人が開設する専用の銀行口座で、小切手を振り出したり、取引先からの振込を受けたりする口座をイメージしてください。\n\n【仕訳パターン】\n・入金時: 借方に当座預金、貸方に売掛金等\n・支払時: 借方に買掛金等、貸方に当座預金\n\n【間違えやすいポイント】\n・普通預金と当座預金を混同しやすい\n・他人振出小切手は「現金」として扱う\n・当座借越の処理方法\n\n【覚え方のコツ】\n・「当座」= その場での決済用\n・小切手 = 当座預金から支払う\n・入金で当座預金増加（借方）\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "当座預金残高が不足したため、買掛金400円の支払いで当座借越となった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":400,"credit_account":"当座借越","credit_amount":400}}',
    explanation:
      "【基本概念】\n銀行に開設した決済専用の預金口座で、小切手や手形の決済に使用されます。利息は付きません。\n\n【具体例・イメージ】\n法人が開設する専用の銀行口座で、小切手を振り出したり、取引先からの振込を受けたりする口座をイメージしてください。\n\n【仕訳パターン】\n・入金時: 借方に当座預金、貸方に売掛金等\n・支払時: 借方に買掛金等、貸方に当座預金\n\n【間違えやすいポイント】\n・普通預金と当座預金を混同しやすい\n・他人振出小切手は「現金」として扱う\n・当座借越の処理方法\n\n【覚え方のコツ】\n・「当座」= その場での決済用\n・小切手 = 当座預金から支払う\n・入金で当座預金増加（借方）\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "現金実査の結果、現金の実際有高が10円であったが、帳簿残高は300円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金過不足","debit_amount":250,"credit_account":"現金","credit_amount":250}}',
    explanation:
      "【基本概念】\n現金の実際有高と帳簿残高に差額が生じた場合に使用する一時的な勘定科目です。帳簿上の現金残高と実際の現金有高を照合（現金実査）して差額を調整します。\n\n【具体例・イメージ】\nコンビニのレジで、営業終了後にレジの現金を数えたら売上記録と金額が合わない状況をイメージしてください。この差額を一時的に記録するための勘定科目が「現金過不足」です。\n\n【仕訳パターン】\n・実際有高 < 帳簿残高（現金不足）: 借方に現金過不足、貸方に現金\n・実際有高 > 帳簿残高（現金過剰）: 借方に現金、貸方に現金過不足\n\n【間違えやすいポイント】\n・実際有高と帳簿残高の大小関係を逆に覚えがち\n・現金過不足は決算時に必ず他の勘定に振り替える必要がある\n・原因判明時は適切な勘定科目に、不明時は雑損・雑益に振り替え\n\n【覚え方のコツ】\n・「実際に数えて少ない」→「現金が減った」→「貸方に現金」\n・「帳簿より多い」→「現金が増えた」→「借方に現金」\n・現金過不足は「仮の勘定」で、必ず決算で整理される\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":500,"credit_account":"当座借越","credit_amount":500}}',
    explanation:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "現金実査の結果、現金の実際有高が500円であったが、帳簿残高は300円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":300,"credit_account":"現金過不足","credit_amount":300}}',
    explanation:
  ...
  },
  {
    id: "Q_J_014",
    category_id: "journal",
    question_text: "小口現金係に3000円を前渡しした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"小口現金","debit_amount":3000,"credit_account":"現金","credit_amount":3000}}',
    explanation:
      "【基本概念】\n日常の少額支払いに備えて、担当者に前渡しする現金です。定額資金前渡制度（インプレスト・システム）で管理されます。\n\n【具体例・イメージ】\n会社の事務用品購入や交通費支払いのために、経理担当者が一定額の現金を机の引き出しに保管している状況をイメージしてください。\n\n【仕訳パターン】\n・前渡し時: 借方に小口現金、貸方に現金\n・補給時: 借方に各種費用、貸方に小口現金（使用分のみ）\n\n【間違えやすいポイント】\n・「前渡し」と「補給」の処理を混同しやすい\n・補給時は使用した金額分だけを処理する\n・小口現金は資産勘定で、常に一定額を保持する\n\n【覚え方のコツ】\n・「小口現金を渡す」→「小口現金が増える（借方）」\n・「小さな支払い用の現金」→「小口現金」\n・定額制なので、使った分だけ補給する\n\n【この問題の仕訳】\n借方：小口現金 3000円\n貸方：現金 3000円",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "現金実査の結果、現金の実際有高が350円であったが、帳簿残高は500円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金過不足","debit_amount":250,"credit_account":"現金","credit_amount":250}}',
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "現金実査の結果、現金の実際有高が500円であったが、帳簿残高は10円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":500,"credit_account":"現金過不足","credit_amount":500}}',
    explanation:
      "【基本概念】\n現金の実際有高と帳簿残高に差額が生じた場合に使用する一時的な勘定科目です。企業では「日々チェック」し、横領リスクを防ぐために現金をかぞえ、帳簿と合っているか確認します。\n\n【具体例・イメージ】\nコンビニのレジで、営業終了後にレジの現金を数えたら売上記録と金額が合わない状況をイメージしてください。この差額を一時的に記録するための勘定科目が「現金過不足」です。\n\n【仕訳パターン】\n・実際有高 < 帳簿残高（現金不足）: 借方に現金過不足、貸方に現金\n・実際有高 > 帳簿残高（現金過剰）: 借方に現金、貸方に現金過不足\n\n【間違えやすいポイント】\n・実際有高と帳簿残高の大小関係を逆に覚えがち\n・現金過不足は決算時に必ず他の勘定に振り替える必要がある\n・原因判明時は適切な勘定科目に、不明時は雑損・雑益に振り替え\n\n【覚え方のコツ】\n・「実際に数えて少ない」→「現金が減った」→「貸方に現金」\n・「帳簿より多い」→「現金が増えた」→「借方に現金」\n・現金過不足は「仮の勘定」で、必ず決算で整理される\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_022",
    category_id: "journal",
    question_text: "小口現金係に2500円を前渡しした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"小口現金","debit_amount":2500,"credit_account":"現金","credit_amount":2500}}',
    explanation:
      "【基本概念】\n日常の少額支払いに備えて、担当者に前渡しする現金です。定額資金前渡制度（インプレスト・システム）で管理され、営業部や企画部などの各部署に、あらかじめ少額の現金を渡して、電車代などの細かな支払いをまかなってもらいます。\n\n【具体例・イメージ】\n大きな企業で、営業部の担当者が出張するための切符を買う時に、いちいち経理部まで行って現金をもらうのは大変です。そこで、各部署に一定額の現金を預けておく状況をイメージしてください。\n\n【仕訳パターン】\n・前渡し時: 借方に小口現金、貸方に現金\n・支払報告時: 借方に各種費用、貸方に小口現金\n・補給時: 借方に小口現金、貸方に現金（使用分のみ）\n・即時補給: 借方に各種費用、貸方に現金（まとめて処理）\n\n【間違えやすいポイント】\n・「前渡し」と「補給」の処理を混同しやすい\n・補給時は使用した金額分だけを処理する\n・小口現金は資産勘定で、常に一定額を保持する\n・仕訳は会計係の立場から行う（小口係の処理は仕訳対象外）\n\n【覚え方のコツ】\n・「小口現金を渡す」→「小口現金が増える（借方）」\n・「小さな支払い用の現金」→「小口現金」\n・定額制なので、使った分だけ補給する\n・①前渡し→②支払い→③報告→④補給のサイクル\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_023",
    category_id: "journal",
    question_text: "売掛金100円が当座預金口座に振り込まれた。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"当座預金","debit_amount":100,"credit_account":"売掛金","credit_amount":100}}',
    explanation:
      "【基本概念】\n銀行に開設した決済専用の預金口座で、小切手や手形の決済に使用されます。利息は付きません。法人が開設する専用の銀行口座です。\n\n【具体例・イメージ】\n法人が開設する専用の銀行口座で、小切手を振り出したり、取引先からの振込を受けたりする口座をイメージしてください。\n\n【仕訳パターン】\n・入金時: 借方に当座預金、貸方に売掛金等\n・支払時（残高あり）: 借方に買掛金等、貸方に当座預金\n・支払時（残高不足）: 借方に買掛金等、貸方に当座借越\n\n【間違えやすいポイント】\n・普通預金と当座預金を混同しやすい\n・他人振出小切手は「現金」として扱う\n・当座借越の処理方法（決算時の振替が必要）\n\n【覚え方のコツ】\n・「当座」= その場での決済用\n・小切手 = 当座預金から支払う\n・入金で当座預金増加（借方）\n・残高不足でも小切手振出可能（当座借越契約時）\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "当座預金残高が不足したため、買掛金2500円の支払いで当座借越となった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":2500,"credit_account":"当座借越","credit_amount":2500}}',
    explanation:
      "【基本概念】\n当座預金残高を超えて引き出しを行った時に生じた銀行への支払い債務です。事前に銀行と当座借越契約を結ぶことにより、一定額までなら残高を超えても小切手を振り出すことが可能となります。\n\n【具体例・イメージ】\nクレジットカードの利用限度額のように、銀行と契約することで預金残高を超えても一定額まで支払いができる仕組みをイメージしてください。\n\n【仕訳パターン】\n・残高不足での支払時: 借方に費用等、貸方に当座預金（期中）\n・決算時の振替: 借方に当座預金、貸方に当座借越\n・翌期首の再振替: 借方に当座借越、貸方に当座預金\n\n【間違えやすいポイント】\n・期中と決算時の処理を混同しやすい\n・当座預金の貸方残高を放置してはいけない\n・当座借越は負債勘定であることを忘れがち\n\n【覚え方のコツ】\n・当座預金がマイナス（貸方残高）→決算で当座借越に振替\n・資産のマイナスは不自然→負債に移す\n・翌期首は逆仕訳で元に戻す\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_027",
    category_id: "journal",
    question_text: "売掛金150円が当座預金口座に振り込まれた。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"当座預金","debit_amount":150,"credit_account":"売掛金","credit_amount":150}}',
    explanation:
      "【基本概念】\n銀行に開設した決済専用の預金口座で、小切手や手形の決済に使用されます。利息は付きません。法人が開設する専用の銀行口座です。\n\n【具体例・イメージ】\n法人が開設する専用の銀行口座で、小切手を振り出したり、取引先からの振込を受けたりする口座をイメージしてください。\n\n【仕訳パターン】\n・入金時: 借方に当座預金、貸方に売掛金等\n・支払時（残高あり）: 借方に買掛金等、貸方に当座預金\n・支払時（残高不足）: 借方に買掛金等、貸方に当座借越\n\n【間違えやすいポイント】\n・普通預金と当座預金を混同しやすい\n・他人振出小切手は「現金」として扱う\n・当座借越の処理方法（決算時の振替が必要）\n\n【覚え方のコツ】\n・「当座」= その場での決済用\n・小切手 = 当座預金から支払う\n・入金で当座預金増加（借方）\n・残高不足でも小切手振出可能（当座借越契約時）\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "現金実査の結果、現金の実際有高が150円であったが、帳簿残高は250円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":150,"credit_account":"現金過不足","credit_amount":150}}',
    explanation:
      "【基本概念】\n現金の実際有高と帳簿残高に差額が生じた場合に使用する一時的な勘定科目です。企業では「日々チェック」し、横領リスクを防ぐために現金をかぞえ、帳簿と合っているか確認します。\n\n【具体例・イメージ】\nコンビニのレジで、営業終了後にレジの現金を数えたら売上記録と金額が合わない状況をイメージしてください。この差額を一時的に記録するための勘定科目が「現金過不足」です。\n\n【仕訳パターン】\n・実際有高 < 帳簿残高（現金不足）: 借方に現金過不足、貸方に現金\n・実際有高 > 帳簿残高（現金過剰）: 借方に現金、貸方に現金過不足\n\n【間違えやすいポイント】\n・実際有高と帳簿残高の大小関係を逆に覚えがち\n・現金過不足は決算時に必ず他の勘定に振り替える必要がある\n・原因判明時は適切な勘定科目に、不明時は雑損・雑益に振り替え\n\n【覚え方のコツ】\n・「実際に数えて少ない」→「現金が減った」→「貸方に現金」\n・「帳簿より多い」→「現金が増えた」→「借方に現金」\n・現金過不足は「仮の勘定」で、必ず決算で整理される\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_030",
    category_id: "journal",
    question_text: "小口現金係に400円を前渡しした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"小口現金","debit_amount":400,"credit_account":"現金","credit_amount":400}}',
    explanation:
      "【基本概念】\n日常の少額支払いに備えて、担当者に前渡しする現金です。定額資金前渡制度（インプレスト・システム）で管理され、営業部や企画部などの各部署に、あらかじめ少額の現金を渡して、電車代などの細かな支払いをまかなってもらいます。\n\n【具体例・イメージ】\n大きな企業で、営業部の担当者が出張するための切符を買う時に、いちいち経理部まで行って現金をもらうのは大変です。そこで、各部署に一定額の現金を預けておく状況をイメージしてください。\n\n【仕訳パターン】\n・前渡し時: 借方に小口現金、貸方に現金\n・支払報告時: 借方に各種費用、貸方に小口現金\n・補給時: 借方に小口現金、貸方に現金（使用分のみ）\n・即時補給: 借方に各種費用、貸方に現金（まとめて処理）\n\n【間違えやすいポイント】\n・「前渡し」と「補給」の処理を混同しやすい\n・補給時は使用した金額分だけを処理する\n・小口現金は資産勘定で、常に一定額を保持する\n・仕訳は会計係の立場から行う（小口係の処理は仕訳対象外）\n\n【覚え方のコツ】\n・「小口現金を渡す」→「小口現金が増える（借方）」\n・「小さな支払い用の現金」→「小口現金」\n・定額制なので、使った分だけ補給する\n・①前渡し→②支払い→③報告→④補給のサイクル\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_031",
    category_id: "journal",
    question_text: "売掛金3000円が当座預金口座に振り込まれた。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"当座預金","debit_amount":3000,"credit_account":"売掛金","credit_amount":3000}}',
    explanation:
      "【基本概念】\n銀行に開設した決済専用の預金口座で、小切手や手形の決済に使用されます。利息は付きません。\n\n【具体例・イメージ】\n法人が開設する専用の銀行口座で、小切手を振り出したり、取引先からの振込を受けたりする口座をイメージしてください。\n\n【仕訳パターン】\n・入金時: 借方に当座預金、貸方に売掛金等\n・支払時: 借方に買掛金等、貸方に当座預金\n\n【間違えやすいポイント】\n・普通預金と当座預金を混同しやすい\n・他人振出小切手は「現金」として扱う\n・当座借越の処理方法\n\n【覚え方のコツ】\n・「当座」= その場での決済用\n・小切手 = 当座預金から支払う\n・入金で当座預金増加（借方）\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "当座預金残高が不足したため、買掛金3000円の支払いで当座借越となった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":3000,"credit_account":"当座借越","credit_amount":3000}}',
    explanation:
      "【基本概念】\n当座預金残高を超えて引き出しを行った時に生じた銀行への支払い債務です。事前に銀行と当座借越契約を結ぶことにより、一定額までなら残高を超えても小切手を振り出すことが可能となります。\n\n【具体例・イメージ】\nクレジットカードの利用限度額のように、銀行と契約することで預金残高を超えても一定額まで支払いができる仕組みをイメージしてください。\n\n【仕訳パターン】\n・残高不足での支払時: 借方に費用等、貸方に当座預金（期中）\n・決算時の振替: 借方に当座預金、貸方に当座借越\n・翌期首の再振替: 借方に当座借越、貸方に当座預金\n\n【間違えやすいポイント】\n・期中と決算時の処理を混同しやすい\n・当座預金の貸方残高を放置してはいけない\n・当座借越は負債勘定であることを忘れがち\n\n【覚え方のコツ】\n・当座預金がマイナス（貸方残高）→決算で当座借越に振替\n・資産のマイナスは不自然→負債に移す\n・翌期首は逆仕訳で元に戻す\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "現金実査の結果、現金の実際有高が250円であったが、帳簿残高は150円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":250,"credit_account":"現金過不足","credit_amount":250}}',
    explanation:
      "【基本概念】\n現金の実際有高と帳簿残高に差額が生じた場合に使用する一時的な勘定科目です。企業では「日々チェック」し、横領リスクを防ぐために現金をかぞえ、帳簿と合っているか確認します。\n\n【具体例・イメージ】\nコンビニのレジで、営業終了後にレジの現金を数えたら売上記録と金額が合わない状況をイメージしてください。この差額を一時的に記録するための勘定科目が「現金過不足」です。\n\n【仕訳パターン】\n・実際有高 < 帳簿残高（現金不足）: 借方に現金過不足、貸方に現金\n・実際有高 > 帳簿残高（現金過剰）: 借方に現金、貸方に現金過不足\n\n【間違えやすいポイント】\n・実際有高と帳簿残高の大小関係を逆に覚えがち\n・現金過不足は決算時に必ず他の勘定に振り替える必要がある\n・原因判明時は適切な勘定科目に、不明時は雑損・雑益に振り替え\n\n【覚え方のコツ】\n・「実際に数えて少ない」→「現金が減った」→「貸方に現金」\n・「帳簿より多い」→「現金が増えた」→「借方に現金」\n・現金過不足は「仮の勘定」で、必ず決算で整理される\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "現金実査の結果、現金の実際有高が250円であったが、帳簿残高は200円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":250,"credit_account":"現金過不足","credit_amount":250}}',
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "現金実査の結果、現金の実際有高が1500円であったが、帳簿残高は4000円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":1500,"credit_account":"現金過不足","credit_amount":1500}}',
    explanation:
      "【基本概念】\n現金の実際有高と帳簿残高に差額が生じた場合に使用する一時的な勘定科目です。企業では「日々チェック」し、横領リスクを防ぐために現金をかぞえ、帳簿と合っているか確認します。\n\n【具体例・イメージ】\nコンビニのレジで、営業終了後にレジの現金を数えたら売上記録と金額が合わない状況をイメージしてください。この差額を一時的に記録するための勘定科目が「現金過不足」です。\n\n【仕訳パターン】\n・実際有高 < 帳簿残高（現金不足）: 借方に現金過不足、貸方に現金\n・実際有高 > 帳簿残高（現金過剰）: 借方に現金、貸方に現金過不足\n\n【間違えやすいポイント】\n・実際有高と帳簿残高の大小関係を逆に覚えがち\n・現金過不足は決算時に必ず他の勘定に振り替える必要がある\n・原因判明時は適切な勘定科目に、不明時は雑損・雑益に振り替え\n\n【覚え方のコツ】\n・「実際に数えて少ない」→「現金が減った」→「貸方に現金」\n・「帳簿より多い」→「現金が増えた」→「借方に現金」\n・現金過不足は「仮の勘定」で、必ず決算で整理される\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    id: "Q_J_042",
    category_id: "journal",
    question_text: "小口現金係に100円を前渡しした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"小口現金","debit_amount":100,"credit_account":"現金","credit_amount":100}}',
    explanation:
      "【基本概念】\n日常の少額支払いに備えて、担当者に前渡しする現金です。定額資金前渡制度（インプレスト・システム）で管理され、営業部や企画部などの各部署に、あらかじめ少額の現金を渡して、電車代などの細かな支払いをまかなってもらいます。\n\n【具体例・イメージ】\n大きな企業で、営業部の担当者が出張するための切符を買う時に、いちいち経理部まで行って現金をもらうのは大変です。そこで、各部署に一定額の現金を預けておく状況をイメージしてください。\n\n【仕訳パターン】\n・前渡し時: 借方に小口現金、貸方に現金\n・支払報告時: 借方に各種費用、貸方に小口現金\n・補給時: 借方に小口現金、貸方に現金（使用分のみ）\n・即時補給: 借方に各種費用、貸方に現金（まとめて処理）\n\n【間違えやすいポイント】\n・「前渡し」と「補給」の処理を混同しやすい\n・補給時は使用した金額分だけを処理する\n・小口現金は資産勘定で、常に一定額を保持する\n・仕訳は会計係の立場から行う（小口係の処理は仕訳対象外）\n\n【覚え方のコツ】\n・「小口現金を渡す」→「小口現金が増える（借方）」\n・「小さな支払い用の現金」→「小口現金」\n・定額制なので、使った分だけ補給する\n・①前渡し→②支払い→③報告→④補給のサイクル\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    ...
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"仕入","debit_amount":500,"credit_account":"買掛金","credit_amount":500}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_044",
    category_id: "journal",
    question_text: "商品を500円で販売し、代金は現金で受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":500,"credit_account":"売上","credit_amount":500}}',
    explanation:
      "【基本概念】\n商品の仕入れと売上に関する基本的な取引。三分法では仕入・売上・繰越商品の3つの勘定を使用し、仕入は費用、売上は収益、繰越商品は資産として扱います。\n\n【具体例・イメージ】\nスーパーやコンビニでの商品の仕入れと販売をイメージしてください。仕入時は商品代金を支払い、売上時は販売価格で収益を計上します。\n\n【仕訳パターン】\n・仕入時: 借方に仕入、貸方に現金/買掛金\n・売上時: 借方に現金/売掛金、貸方に売上\n・返品時: 逆仕訳で処理\n・値引時: 売上値引/仕入値引勘定で処理\n\n【間違えやすいポイント】\n・分記法と三分法を混同しやすい\n・期末商品の振替処理を忘れがち\n・返品と値引の処理方法を間違える\n・売上原価の計算方法を理解していない\n\n【覚え方のコツ】\n・三分法は「仕入・売上・繰越商品」の3つで管理\n・仕入は費用（左側）、売上は収益（右側）\n・期末は「しくりくりし」（仕訳・繰越・繰越・仕訳）\n・返品は「逆仕訳」、値引は「専用勘定」\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_046",
    category_id: "journal",
    question_text: "売上げた商品のうち500円分が品違いのため返品された。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"売上","debit_amount":500,"credit_account":"売掛金","credit_amount":500}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_051",
    category_id: "journal",
    question_text: "商品200円を仕入れ、代金は掛けとした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"仕入","debit_amount":200,"credit_account":"買掛金","credit_amount":200}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_053",
    category_id: "journal",
    question_text: "仕入れた商品のうち100円分を品違いのため返品した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":100,"credit_account":"仕入","credit_amount":100}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_056",
    category_id: "journal",
    question_text: "商品を4500円で販売し、代金は現金で受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":4500,"credit_account":"売上","credit_amount":4500}}',
    explanation:
      "【基本概念】\n商品の仕入れと売上に関する基本的な取引。三分法では仕入・売上・繰越商品の3つの勘定を使用し、仕入は費用、売上は収益、繰越商品は資産として扱います。\n\n【具体例・イメージ】\nスーパーやコンビニでの商品の仕入れと販売をイメージしてください。仕入時は商品代金を支払い、売上時は販売価格で収益を計上します。\n\n【仕訳パターン】\n・仕入時: 借方に仕入、貸方に現金/買掛金\n・売上時: 借方に現金/売掛金、貸方に売上\n・返品時: 逆仕訳で処理\n・値引時: 売上値引/仕入値引勘定で処理\n\n【間違えやすいポイント】\n・分記法と三分法を混同しやすい\n・期末商品の振替処理を忘れがち\n・返品と値引の処理方法を間違える\n・売上原価の計算方法を理解していない\n\n【覚え方のコツ】\n・三分法は「仕入・売上・繰越商品」の3つで管理\n・仕入は費用（左側）、売上は収益（右側）\n・期末は「しくりくりし」（仕訳・繰越・繰越・仕訳）\n・返品は「逆仕訳」、値引は「専用勘定」\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_058",
    category_id: "journal",
    question_text: "売上げた商品のうち200円分が品違いのため返品された。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"売上","debit_amount":200,"credit_account":"売掛金","credit_amount":200}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_061",
    category_id: "journal",
    question_text: "仕入れた商品のうち200円分を品違いのため返品した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":200,"credit_account":"仕入","credit_amount":200}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_062",
    category_id: "journal",
    question_text: "売上げた商品のうち4500円分が品違いのため返品された。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"売上","debit_amount":4500,"credit_account":"売掛金","credit_amount":4500}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_063",
    category_id: "journal",
    question_text: "商品450円を仕入れ、代金は掛けとした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"仕入","debit_amount":450,"credit_account":"買掛金","credit_amount":450}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_064",
    category_id: "journal",
    question_text: "商品を350円で販売し、代金は現金で受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":350,"credit_account":"売上","credit_amount":350}}',
    explanation:
      "【基本概念】\n商品の仕入れと売上に関する基本的な取引。三分法では仕入・売上・繰越商品の3つの勘定を使用し、仕入は費用、売上は収益、繰越商品は資産として扱います。\n\n【具体例・イメージ】\nスーパーやコンビニでの商品の仕入れと販売をイメージしてください。仕入時は商品代金を支払い、売上時は販売価格で収益を計上します。\n\n【仕訳パターン】\n・仕入時: 借方に仕入、貸方に現金/買掛金\n・売上時: 借方に現金/売掛金、貸方に売上\n・返品時: 逆仕訳で処理\n・値引時: 売上値引/仕入値引勘定で処理\n\n【間違えやすいポイント】\n・分記法と三分法を混同しやすい\n・期末商品の振替処理を忘れがち\n・返品と値引の処理方法を間違える\n・売上原価の計算方法を理解していない\n\n【覚え方のコツ】\n・三分法は「仕入・売上・繰越商品」の3つで管理\n・仕入は費用（左側）、売上は収益（右側）\n・期末は「しくりくりし」（仕訳・繰越・繰越・仕訳）\n・返品は「逆仕訳」、値引は「専用勘定」\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_066",
    category_id: "journal",
    question_text: "売上げた商品のうち100円分が品違いのため返品された。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"売上","debit_amount":100,"credit_account":"売掛金","credit_amount":100}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_067",
    category_id: "journal",
    question_text: "商品3000円を仕入れ、代金は掛けとした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"仕入","debit_amount":3000,"credit_account":"買掛金","credit_amount":3000}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_068",
    category_id: "journal",
    question_text: "商品を250円で販売し、代金は現金で受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":250,"credit_account":"売上","credit_amount":250}}',
    explanation:
      "【基本概念】\n商品の仕入れと売上に関する基本的な取引。三分法では仕入・売上・繰越商品の3つの勘定を使用し、仕入は費用、売上は収益、繰越商品は資産として扱います。\n\n【具体例・イメージ】\nスーパーやコンビニでの商品の仕入れと販売をイメージしてください。仕入時は商品代金を支払い、売上時は販売価格で収益を計上します。\n\n【仕訳パターン】\n・仕入時: 借方に仕入、貸方に現金/買掛金\n・売上時: 借方に現金/売掛金、貸方に売上\n・返品時: 逆仕訳で処理\n・値引時: 売上値引/仕入値引勘定で処理\n\n【間違えやすいポイント】\n・分記法と三分法を混同しやすい\n・期末商品の振替処理を忘れがち\n・返品と値引の処理方法を間違える\n・売上原価の計算方法を理解していない\n\n【覚え方のコツ】\n・三分法は「仕入・売上・繰越商品」の3つで管理\n・仕入は費用（左側）、売上は収益（右側）\n・期末は「しくりくりし」（仕訳・繰越・繰越・仕訳）\n・返品は「逆仕訳」、値引は「専用勘定」\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_069",
    category_id: "journal",
    question_text: "仕入れた商品のうち4000円分を品違いのため返品した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":4000,"credit_account":"仕入","credit_amount":4000}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_071",
    category_id: "journal",
    question_text: "商品4500円を仕入れ、代金は掛けとした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"仕入","debit_amount":4500,"credit_account":"買掛金","credit_amount":4500}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_072",
    category_id: "journal",
    question_text: "商品を150円で販売し、代金は現金で受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":150,"credit_account":"売上","credit_amount":150}}',
    explanation:
      "【基本概念】\n商品の仕入れと売上に関する基本的な取引。三分法では仕入・売上・繰越商品の3つの勘定を使用し、仕入は費用、売上は収益、繰越商品は資産として扱います。\n\n【具体例・イメージ】\nスーパーやコンビニでの商品の仕入れと販売をイメージしてください。仕入時は商品代金を支払い、売上時は販売価格で収益を計上します。\n\n【仕訳パターン】\n・仕入時: 借方に仕入、貸方に現金/買掛金\n・売上時: 借方に現金/売掛金、貸方に売上\n・返品時: 逆仕訳で処理\n・値引時: 売上値引/仕入値引勘定で処理\n\n【間違えやすいポイント】\n・分記法と三分法を混同しやすい\n・期末商品の振替処理を忘れがち\n・返品と値引の処理方法を間違える\n・売上原価の計算方法を理解していない\n\n【覚え方のコツ】\n・三分法は「仕入・売上・繰越商品」の3つで管理\n・仕入は費用（左側）、売上は収益（右側）\n・期末は「しくりくりし」（仕訳・繰越・繰越・仕訳）\n・返品は「逆仕訳」、値引は「専用勘定」\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_073",
    category_id: "journal",
    question_text: "仕入れた商品のうち4500円分を品違いのため返品した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":4500,"credit_account":"仕入","credit_amount":4500}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_074",
    category_id: "journal",
    question_text: "売上げた商品のうち150円分が品違いのため返品された。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"売上","debit_amount":150,"credit_account":"売掛金","credit_amount":150}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_079",
    category_id: "journal",
    question_text: "商品100円を仕入れ、代金は掛けとした。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"仕入","debit_amount":100,"credit_account":"買掛金","credit_amount":100}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    id: "Q_J_082",
    category_id: "journal",
    question_text: "売上げた商品のうち250円分が品違いのため返品された。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"売上","debit_amount":250,"credit_account":"売掛金","credit_amount":250}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    id: "Q_J_088",
    category_id: "journal",
    question_text: "売掛金500円を現金で回収した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":500,"credit_account":"売掛金","credit_amount":500}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_089",
    category_id: "journal",
    question_text: "買掛金500円を小切手を振り出して支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":500,"credit_account":"当座預金","credit_amount":500}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_090",
    category_id: "journal",
    question_text: "売掛金500円の代金として約束手形を受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"受取手形","debit_amount":500,"credit_account":"売掛金","credit_amount":500}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_091",
    category_id: "journal",
    question_text: "買掛金400円の支払いのため約束手形を振り出した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":400,"credit_account":"支払手形","credit_amount":400}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_092",
    category_id: "journal",
    question_text: "売掛金4500円を現金で回収した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":4500,"credit_account":"売掛金","credit_amount":4500}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_093",
    category_id: "journal",
    question_text: "買掛金100円を小切手を振り出して支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":100,"credit_account":"当座預金","credit_amount":100}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_095",
    category_id: "journal",
    question_text: "買掛金150円の支払いのため約束手形を振り出した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":150,"credit_account":"支払手形","credit_amount":150}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_103",
    category_id: "journal",
    question_text: "買掛金2500円の支払いのため約束手形を振り出した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":2500,"credit_account":"支払手形","credit_amount":2500}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_105",
    category_id: "journal",
    question_text: "買掛金3500円を小切手を振り出して支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":3500,"credit_account":"当座預金","credit_amount":3500}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_108",
    category_id: "journal",
    question_text: "売掛金350円を現金で回収した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":350,"credit_account":"売掛金","credit_amount":350}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_110",
    category_id: "journal",
    question_text: "売掛金4500円の代金として約束手形を受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"受取手形","debit_amount":4500,"credit_account":"売掛金","credit_amount":4500}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_113",
    category_id: "journal",
    question_text: "買掛金3000円を小切手を振り出して支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":3000,"credit_account":"当座預金","credit_amount":3000}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_114",
    category_id: "journal",
    question_text: "売掛金400円の代金として約束手形を受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"受取手形","debit_amount":400,"credit_account":"売掛金","credit_amount":400}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_115",
    category_id: "journal",
    question_text: "買掛金250円の支払いのため約束手形を振り出した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":250,"credit_account":"支払手形","credit_amount":250}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_116",
    category_id: "journal",
    question_text: "売掛金4000円を現金で回収した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":4000,"credit_account":"売掛金","credit_amount":4000}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_118",
    category_id: "journal",
    question_text: "売掛金200円の代金として約束手形を受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"受取手形","debit_amount":200,"credit_account":"売掛金","credit_amount":200}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_119",
    category_id: "journal",
    question_text: "買掛金1250円の支払いのため約束手形を振り出した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":1250,"credit_account":"支払手形","credit_amount":1250}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    id: "Q_J_120",
    category_id: "journal",
    question_text: "売掛金3500円を現金で回収した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":3500,"credit_account":"売掛金","credit_amount":3500}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    id: "Q_J_121",
    category_id: "journal",
    question_text: "買掛金300円を小切手を振り出して支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":300,"credit_account":"当座預金","credit_amount":300}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    id: "Q_J_122",
    category_id: "journal",
    question_text: "売掛金1000円の代金として約束手形を受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"受取手形","debit_amount":1000,"credit_account":"売掛金","credit_amount":1000}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    id: "Q_J_124",
    category_id: "journal",
    question_text: "売掛金3000円を現金で回収した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":3000,"credit_account":"売掛金","credit_amount":3000}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    id: "Q_J_125",
    category_id: "journal",
    question_text: "買掛金10円を小切手を振り出して支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":500,"credit_account":"当座預金","credit_amount":500}}',
  ...
  },
  {
    id: "Q_J_126",
    category_id: "journal",
    question_text: "売掛金450円の代金として約束手形を受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"受取手形","debit_amount":450,"credit_account":"売掛金","credit_amount":450}}',
    explanation:
      "【基本概念】\n商品やサービスの代金を将来的に受け取る権利があるお金のことで、商品を掛け（信用）で売り上げた際に発生する資産勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お店側が持つ「代金をもらう権利」をイメージしてください。お客様に請求書を渡して、後日代金を回収します。\n\n【仕訳パターン】\n・掛売上時: 借方に売掛金、貸方に売上\n・代金回収時: 借方に現金、貸方に売掛金\n\n【間違えやすいポイント】\n・売掛金（資産）と買掛金（負債）を混同しやすい\n・回収時に売掛金を借方に書いてしまうミス\n・未収入金との区別（本業以外の収入は未収入金）\n\n【覚え方のコツ】\n・「売」掛金 = 「売った」ツケ = もらう権利（資産）\n・「権利」は資産、「義務」は負債\n・回収すると売掛金は減る（貸方）\n・売る側に発生するのが「売掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    id: "Q_J_127",
    category_id: "journal",
    question_text: "買掛金300円の支払いのため約束手形を振り出した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"買掛金","debit_amount":300,"credit_account":"支払手形","credit_amount":300}}',
    explanation:
      "【基本概念】\n商品やサービスを購入した際の掛け取引で使用する勘定科目で、あとから支払わなければならないお金（代金を支払う義務）を表す負債勘定です。\n\n【具体例・イメージ】\nツケで食事をした時の、お客側が持つ「代金を払う義務」をイメージしてください。後日、お店に代金を支払います。\n\n【仕訳パターン】\n・掛仕入時: 借方に仕入、貸方に買掛金\n・代金支払時: 借方に買掛金、貸方に現金\n\n【間違えやすいポイント】\n・買掛金（負債）と売掛金（資産）を混同しやすい\n・支払時に買掛金を貸方に書いてしまうミス\n・未払金との区別（本業以外の支出は未払金）\n\n【覚え方のコツ】\n・「買」掛金 = 「買った」ツケ = 払う義務（負債）\n・支払うと買掛金は減る（借方）\n・「義務」は負債、「権利」は資産\n・買う側に発生するのが「買掛金」\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 3,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "従業員に給料500円を支払った。なお、源泉所得税150円を差し引いた。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "社会保険料500円（会社負担200円、従業員負担10円）を現金で支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
  ...
  },
  {
    id: "Q_J_131",
    category_id: "journal",
    question_text: "固定資産税100円を現金で納付した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"租税公課","debit_amount":100,"credit_account":"現金","credit_amount":100}}',
    explanation:
      "【基本概念】\n銀行に開設した決済専用の預金口座で、小切手や手形の決済に使用されます。利息は付きません。法人が開設する専用の銀行口座です。\n\n【具体例・イメージ】\n法人が開設する専用の銀行口座で、小切手を振り出したり、取引先からの振込を受けたりする口座をイメージしてください。\n\n【仕訳パターン】\n・入金時: 借方に当座預金、貸方に売掛金等\n・支払時（残高あり）: 借方に買掛金等、貸方に当座預金\n・支払時（残高不足）: 借方に買掛金等、貸方に当座借越\n\n【間違えやすいポイント】\n・普通預金と当座預金を混同しやすい\n・他人振出小切手は「現金」として扱う\n・当座借越の処理方法（決算時の振替が必要）\n\n【覚え方のコツ】\n・「当座」= その場での決済用\n・小切手 = 当座預金から支払う\n・入金で当座預金増加（借方）\n・残高不足でも小切手振出可能（当座借越契約時）\n\n【この問題の仕訳】\n【この問題の仕訳】\n（仕訳データの解析に失敗しました）",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "従業員に給料200円を支払った。なお、源泉所得税500円を差し引いた。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"給料","debit_amount":200,"credit_account":"現金","credit_amount":200}}',
    explanation:
      "【基本概念】\n従業員への給与支払いと関連する社会保険料・源泉徴収の処理。給与総額から各種控除額を差し引いた手取額を支給します。\n\n【具体例・イメージ】\n毎月の給与明細で天引きされる項目をイメージしてください。総支給額から健康保険料、厚生年金保険料、雇用保険料、所得税が控除されます。\n\n【仕訳パターン】\n・給与支給時: 借方に給料、貸方に各種預り金と現金\n・社会保険料納付時: 借方に法定福利費・預り金、貸方に現金\n・源泉所得税納付時: 借方に預り金、貸方に現金\n\n【間違えやすいポイント】\n・総支給額と手取額を混同する\n・会社負担分と従業員負担分を間違える\n・預り金の処理を忘れる\n・賞与の社会保険料計算を間違える\n\n【覚え方のコツ】\n・給料は「総額で計上、差額は預り金」\n・社会保険料は「労使折半」\n・源泉徴収は「会社が代理納付」\n・預り金は負債（いずれ支払う義務）\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "社会保険料10円（会社負担400円、従業員負担10円）を現金で支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"法定福利費","debit_amount":60,"credit_account":"預り金","credit_amount":60}}',
    explanation:
      "【基本概念】\n法人税等、消費税、固定資産税、印紙税などの税金処理。租税公課として費用計上するものと、仮払・仮受で処理するものがあります。\n\n【具体例・イメージ】\n会社が納める法人税や、商品に含まれる消費税、事務所の固定資産税などをイメージしてください。税金の種類により処理方法が異なります。\n\n【仕訳パターン】\n・法人税等: 借方に法人税等、貸方に未払法人税等\n・消費税（税抜）: 借方に仮払消費税、貸方に現金\n・固定資産税: 借方に租税公課、貸方に現金\n\n【間違えやすいポイント】\n・税込経理と税抜経理を混同する\n・消費税の仮払・仮受を間違える\n・法人税等の処理時期を間違える\n・租税公課に含まれない税金を理解していない\n\n【覚え方のコツ】\n・法人税等は「当期利益への課税」\n・消費税は「預り・立替」\n・租税公課は「事業活動に関する税金」\n・税抜経理では「仮払・仮受」を使用\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "従業員に給料3000円を支払った。なお、源泉所得税750円を差し引いた。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"給料","debit_amount":3000,"credit_account":"現金","credit_amount":3000}}',
    explanation:
      "【基本概念】\n従業員への給与支払いと関連する社会保険料・源泉徴収の処理。給与総額から各種控除額を差し引いた手取額を支給します。\n\n【具体例・イメージ】\n毎月の給与明細で天引きされる項目をイメージしてください。総支給額から健康保険料、厚生年金保険料、雇用保険料、所得税が控除されます。\n\n【仕訳パターン】\n・給与支給時: 借方に給料、貸方に各種預り金と現金\n・社会保険料納付時: 借方に法定福利費・預り金、貸方に現金\n・源泉所得税納付時: 借方に預り金、貸方に現金\n\n【間違えやすいポイント】\n・総支給額と手取額を混同する\n・会社負担分と従業員負担分を間違える\n・預り金の処理を忘れる\n・賞与の社会保険料計算を間違える\n\n【覚え方のコツ】\n・給料は「総額で計上、差額は預り金」\n・社会保険料は「労使折半」\n・源泉徴収は「会社が代理納付」\n・預り金は負債（いずれ支払う義務）\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "社会保険料10円（会社負担250円、従業員負担10円）を現金で支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"法定福利費","debit_amount":500,"credit_account":"預り金","credit_amount":500}}',
  ...
  },
  {
    id: "Q_J_144",
    category_id: "journal",
    question_text: "法人税等150円を当座預金から納付した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"法人税等","debit_amount":150,"credit_account":"当座預金","credit_amount":150}}',
    explanation:
      "【基本概念】\n商品の仕入れと売上に関する基本的な取引。三分法では仕入・売上・繰越商品の3つの勘定を使用し、仕入は費用、売上は収益、繰越商品は資産として扱います。\n\n【具体例・イメージ】\nスーパーやコンビニでの商品の仕入れと販売をイメージしてください。仕入時は商品代金を支払い、売上時は販売価格で収益を計上します。\n\n【仕訳パターン】\n・仕入時: 借方に仕入、貸方に現金/買掛金\n・売上時: 借方に現金/売掛金、貸方に売上\n・返品時: 逆仕訳で処理\n・値引時: 売上値引/仕入値引勘定で処理\n\n【間違えやすいポイント】\n・分記法と三分法を混同しやすい\n・期末商品の振替処理を忘れがち\n・返品と値引の処理方法を間違える\n・売上原価の計算方法を理解していない\n\n【覚え方のコツ】\n・三分法は「仕入・売上・繰越商品」の3つで管理\n・仕入は費用（左側）、売上は収益（右側）\n・期末は「しくりくりし」（仕訳・繰越・繰越・仕訳）\n・返品は「逆仕訳」、値引は「専用勘定」\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "社会保険料500円（会社負担350円、従業員負担10円）を現金で支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"法定福利費","debit_amount":500,"credit_account":"預り金","credit_amount":500}}',
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "社会保険料450円（会社負担100円、従業員負担10円）を現金で支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"法定福利費","debit_amount":450,"credit_account":"預り金","credit_amount":450}}',
    explanation:
      "【基本概念】\n法人税等、消費税、固定資産税、印紙税などの税金処理。租税公課として費用計上するものと、仮払・仮受で処理するものがあります。\n\n【具体例・イメージ】\n会社が納める法人税や、商品に含まれる消費税、事務所の固定資産税などをイメージしてください。税金の種類により処理方法が異なります。\n\n【仕訳パターン】\n・法人税等: 借方に法人税等、貸方に未払法人税等\n・消費税（税抜）: 借方に仮払消費税、貸方に現金\n・固定資産税: 借方に租税公課、貸方に現金\n\n【間違えやすいポイント】\n・税込経理と税抜経理を混同する\n・消費税の仮払・仮受を間違える\n・法人税等の処理時期を間違える\n・租税公課に含まれない税金を理解していない\n\n【覚え方のコツ】\n・法人税等は「当期利益への課税」\n・消費税は「預り・立替」\n・租税公課は「事業活動に関する税金」\n・税抜経理では「仮払・仮受」を使用\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    id: "Q_J_152",
    category_id: "journal",
    question_text: "法人税等1500円を当座預金から納付した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"法人税等","debit_amount":1500,"credit_account":"当座預金","credit_amount":1500}}',
    explanation:
      "【基本概念】\n商品の仕入れと売上に関する基本的な取引。三分法では仕入・売上・繰越商品の3つの勘定を使用し、仕入は費用、売上は収益、繰越商品は資産として扱います。\n\n【具体例・イメージ】\nスーパーやコンビニでの商品の仕入れと販売をイメージしてください。仕入時は商品代金を支払い、売上時は販売価格で収益を計上します。\n\n【仕訳パターン】\n・仕入時: 借方に仕入、貸方に現金/買掛金\n・売上時: 借方に現金/売掛金、貸方に売上\n・返品時: 逆仕訳で処理\n・値引時: 売上値引/仕入値引勘定で処理\n\n【間違えやすいポイント】\n・分記法と三分法を混同しやすい\n・期末商品の振替処理を忘れがち\n・返品と値引の処理方法を間違える\n・売上原価の計算方法を理解していない\n\n【覚え方のコツ】\n・三分法は「仕入・売上・繰越商品」の3つで管理\n・仕入は費用（左側）、売上は収益（右側）\n・期末は「しくりくりし」（仕訳・繰越・繰越・仕訳）\n・返品は「逆仕訳」、値引は「専用勘定」\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "社会保険料250円（会社負担250円、従業員負担10円）を現金で支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"entries":[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]}}',
    correct_answer_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "社会保険料400円（会社負担350円、従業員負担10円）を現金で支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"entries":[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]}}',
    correct_answer_json:
      '{"journalEntry":{"entries":[{"debit_account":"法定福利費","debit_amount":500,"credit_account":"現金","credit_amount":500},{"debit_account":"預り金","debit_amount":500,"credit_account":"","credit_amount":0}],"debit_amount":null,"credit_amount":null}}',
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "社会保険料10円（会社負担500円、従業員負担10円）を現金で支払った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"法定福利費","debit_amount":40,"credit_account":"預り金","credit_amount":40}}',
    explanation:
  ...
  },
  {
    id: "Q_J_172",
    category_id: "journal",
    question_text: "決算において、建物の減価償却費250円を計上する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"減価償却費","debit_amount":250,"credit_account":"建物減価償却累計額","credit_amount":250}}',
    explanation:
      "【基本概念】\n商品の仕入れと売上に関する基本的な取引。三分法では仕入・売上・繰越商品の3つの勘定を使用し、仕入は費用、売上は収益、繰越商品は資産として扱います。\n\n【具体例・イメージ】\nスーパーやコンビニでの商品の仕入れと販売をイメージしてください。仕入時は商品代金を支払い、売上時は販売価格で収益を計上します。\n\n【仕訳パターン】\n・仕入時: 借方に仕入、貸方に現金/買掛金\n・売上時: 借方に現金/売掛金、貸方に売上\n・返品時: 逆仕訳で処理\n・値引時: 売上値引/仕入値引勘定で処理\n\n【間違えやすいポイント】\n・分記法と三分法を混同しやすい\n・期末商品の振替処理を忘れがち\n・返品と値引の処理方法を間違える\n・売上原価の計算方法を理解していない\n\n【覚え方のコツ】\n・三分法は「仕入・売上・繰越商品」の3つで管理\n・仕入は費用（左側）、売上は収益（右側）\n・期末は「しくりくりし」（仕訳・繰越・繰越・仕訳）\n・返品は「逆仕訳」、値引は「専用勘定」\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "使用不能となった備品（取得原価10円、減価償却累計額450円）を除却した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"備品減価償却累計額","debit_amount":90,"credit_account":"固定資産除却損","credit_amount":90}}',
