...
export const masterQuestions: Question[] = [
  ...
  },
  {
    ...
    difficulty: 3,
    tags_json:
      '{"subcategory":"year_end_adjustment","pattern":"実際貸倒引当金充当不足分損失","accounts":["貸倒引当金","売掛金","貸倒損失"],"keywords":["貸倒引当金","実際貸倒","引当金充当","不足分","貸倒損失"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    difficulty: 3,
    tags_json:
      '{"subcategory":"year_end_adjustment","pattern":"売上債権以外引当金設定","accounts":["貸倒引当金繰入","貸倒引当金","貸付金"],"keywords":["貸倒引当金","貸付金","引当率","売上債権以外"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
