...
export const masterQuestions: Question[] = [
  ...
  },
  {
    ...
    explanation:
      "【基本概念】\n固定資産の時間経過による価値減少を金額で表したもの。簿記3級では定額法（毎期一定額）を使用し、間接法で減価償却累計額勘定を用います。\n\n【具体例・イメージ】\n車や機械が年々古くなって価値が下がることをイメージしてください。取得原価を耐用年数で割って、毎年一定額ずつ費用計上します。\n\n【仕訳パターン】\n・減価償却時: 借方に減価償却費、貸方に減価償却累計額\n・計算式: (取得原価-残存価額)÷耐用年数\n・月割計算: 年間償却額×利用月数÷12\n\n【間違えやすいポイント】\n・直接法と間接法を混同する\n・残存価額を忘れて計算する\n・期中取得の月割計算を間違える\n・土地は減価償却しないことを忘れる\n\n【覚え方のコツ】\n・間接法は「累計額」を使用\n・定額法は「毎年同じ金額」\n・土地は「価値が減らない」\n・期中取得は「月割り計算」\n\n【この問題の解き方】\n減価償却費の計上時は、借方に減価償却費（費用の増加）、貸方に建物減価償却累計額（資産の減価）で仕訳します。",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":[{"debit_account":"現金","debit_amount":450,"credit_account":"","credit_amount":0},{"debit_account":"固定資産売却損","debit_amount":50,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"車両","credit_amount":500}]}',
    explanation:
      "【基本概念】\n固定資産の売却時は、帳簿価額と売却価額の差額を売却損益で処理します。帳簿価額より低い価格での売却は売却損となります。\n\n【具体例・イメージ】\n会社の車両を中古車業者に売却することをイメージしてください。購入時より価値が下がっているため、通常は帳簿価額より低い価格での売却になります。\n\n【仕訳パターン】\n・売却損の場合: 借方に現金・固定資産売却損、貸方に各固定資産\n・売却益の場合: 借方に現金、貸方に各固定資産・固定資産売却益\n\n【間違えやすいポイント】\n・帳簿価額と売却価額の差額処理を忘れる\n・売却損益の計算を間違える\n・期中売却時の減価償却計算を忘れる\n\n【覚え方のコツ】\n・帳簿価額＞売却価額 → 売却損\n・帳簿価額＜売却価額 → 売却益\n・売却時は必ず差額を損益で調整\n\n【この問題の解き方】\n帳簿価額500円＞売却価額450円なので売却損50円が発生します。借方に現金450円・固定資産売却損50円、貸方に車両500円で仕訳します。",
    difficulty: 1,
    tags_json:
      '{"subcategory":"fixed_asset","pattern":"固定資産売却","accounts":["現金","車両","固定資産売却損"],"keywords":["固定資産売却","車両","売却損"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "使用不能となった備品（取得原価500円、減価償却累計額450円）を除却した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":[{"debit_account":"備品減価償却累計額","debit_amount":450,"credit_account":"","credit_amount":0},{"debit_account":"固定資産除却損","debit_amount":50,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"備品","credit_amount":500}]}',
    explanation:
      "【基本概念】\n固定資産の除却時は、減価償却累計額と帳簿価額の差額を除却損として処理します。帳簿価額は取得原価から減価償却累計額を差し引いた残額です。\n\n【具体例・イメージ】\n故障して修理不能になったパソコンを廃棄することをイメージしてください。取得原価から今まで償却した分を除いた残りの価値が除却損になります。\n\n【仕訳パターン】\n・除却時: 借方に減価償却累計額・固定資産除却損、貸方に各固定資産\n・帳簿価額 = 取得原価 - 減価償却累計額\n・除却損 = 帳簿価額（残存価値がある場合）\n\n【間違えやすいポイント】\n・帳簿価額の計算を間違える\n・減価償却累計額を忘れる\n・除却損の金額を間違える\n・除却と売却の処理を混同する\n\n【覚え方のコツ】\n・除却は「価値ゼロで廃棄」\n・累計額は必ず借方で消去\n・帳簿価額の残りが除却損\n・取得原価は必ず貸方で消去\n\n【この問題の解き方】\n取得原価500円-減価償却累計額450円=帳簿価額50円が除却損となります。借方に備品減価償却累計額450円・固定資産除却損50円、貸方に備品500円で仕訳します。",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":[{"debit_account":"現金","debit_amount":500,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"車両","credit_amount":300},{"debit_account":"","debit_amount":0,"credit_account":"固定資産売却益","credit_amount":200}]}',
    explanation:
      "【基本概念】\n固定資産の売却時は、帳簿価額と売却価額の差額を売却損益で処理します。帳簿価額より高い価格での売却は売却益となります。\n\n【具体例・イメージ】\n会社の車両を市場価格より高く売却できた場合をイメージしてください。帳簿価額より高い価格で売却できた差額が売却益になります。\n\n【仕訳パターン】\n・売却損の場合: 借方に現金・固定資産売却損、貸方に各固定資産\n・売却益の場合: 借方に現金、貸方に各固定資産・固定資産売却益\n\n【間違えやすいポイント】\n・帳簿価額と売却価額の差額処理を忘れる\n・売却損益の計算を間違える\n・期中売却時の減価償却計算を忘れる\n\n【覚え方のコツ】\n・帳簿価額＞売却価額 → 売却損\n・帳簿価額＜売却価額 → 売却益\n・売却時は必ず差額を損益で調整\n\n【この問題の解き方】\n帳簿価額300円＜売却価額500円なので売却益200円が発生します。借方に現金500円、貸方に車両300円・固定資産売却益200円で仕訳します。",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "使用不能となった備品（取得原価300円、減価償却累計額250円）を除却した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":[{"debit_account":"備品減価償却累計額","debit_amount":250,"credit_account":"","credit_amount":0},{"debit_account":"固定資産除却損","debit_amount":50,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"備品","credit_amount":300}]}',
    explanation:
      "【基本概念】\n1年を超えて使用する資産で、土地・建物・備品・車両運搬具などがあります。取得時は取得原価で計上し、土地以外は減価償却を行います。\n\n【具体例・イメージ】\n会社の事務所、机、パソコン、営業車などをイメージしてください。長期間使用する資産で、購入時に全額費用にせず、使用期間にわたって費用配分します。\n\n【仕訳パターン】\n・購入時: 借方に各固定資産、貸方に現金等\n・除却時: 借方に固定資産除却損、減価償却累計額、貸方に各固定資産\n・売却時: 借方に現金・固定資産売却損、減価償却累計額、貸方に各固定資産・固定資産売却益\n\n【間違えやすいポイント】\n・取得原価に付随費用を含め忘れる\n・土地の減価償却をしてしまう\n・除却と売却の処理を混同する\n・期中売却時の減価償却計算を忘れる\n\n【覚え方のコツ】\n・取得原価は「本体価格＋付随費用」\n・土地は「価値が減らない」\n・除却は「廃棄」、売却は「換金」\n・期中売却は「売却日まで償却」\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "帳簿価額500円の車両を400円で売却し、代金は現金で受け取った。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":[{"debit_account":"現金","debit_amount":400,"credit_account":"","credit_amount":0},{"debit_account":"固定資産売却損","debit_amount":100,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"車両","credit_amount":500}]}',
    explanation:
      "【基本概念】\n固定資産の時間経過による価値減少を金額で表したもの。簿記3級では定額法（毎期一定額）を使用し、間接法で減価償却累計額勘定を用います。\n\n【具体例・イメージ】\n車や機械が年々古くなって価値が下がることをイメージしてください。取得原価を耐用年数で割って、毎年一定額ずつ費用計上します。\n\n【仕訳パターン】\n・減価償却時: 借方に減価償却費、貸方に減価償却累計額\n・計算式: (取得原価-残存価額)÷耐用年数\n・月割計算: 年間償却額×利用月数÷12\n\n【間違えやすいポイント】\n・直接法と間接法を混同する\n・残存価額を忘れて計算する\n・期中取得の月割計算を間違える\n・土地は減価償却しないことを忘れる\n\n【覚え方のコツ】\n・間接法は「累計額」を使用\n・定額法は「毎年同じ金額」\n・土地は「価値が減らない」\n・期中取得は「月割り計算」\n\n【この問題の解き方】\n問題文をよく読み、取引の内容を理解して適切な勘定科目と金額で仕訳しましょう。",
    difficulty: 2,
    tags_json:
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "建物（取得原価1,200,000円、耐用年数20年、残存価額取得原価の10%）について、定額法により決算時の減価償却費を計算して計上する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"減価償却費","debit_amount":54000,"credit_account":"建物減価償却累計額","credit_amount":54000}}',
    explanation:
      "【基本概念】\n定額法は、固定資産の取得原価から残存価額を控除した金額を耐用年数で割って、毎年同じ金額を減価償却費として計上する方法です。\n\n【具体例・イメージ】\n建物や機械など長期間使用する資産は、使用により価値が減少します。この価値の減少分を毎年の費用として配分するのが減価償却です。\n\n【計算式】\n年間減価償却費 = （取得原価 - 残存価額）÷ 耐用年数\n残存価額 = 1,200,000円 × 10% = 120,000円\n年間減価償却費 = （1,200,000円 - 120,000円）÷ 20年 = 54,000円\n\n【仕訳パターン】\n減価償却費の計上：\n借方「減価償却費」、貸方「〇〇減価償却累計額」\n\n【間違えやすいポイント】\n・残存価額を考慮し忘れる\n・取得原価全額を耐用年数で割ってしまう\n・減価償却累計額勘定を使わず、直接資産勘定を減額してしまう\n\n【覚え方のコツ】\n・「取得原価 - 残存価額」が償却対象額\n・減価償却累計額は資産のマイナス勘定（間接法）\n・毎年同額なので「定額法」\n\n【この問題の解き方】\n取得原価1,200,000円、残存価額10%（120,000円）、耐用年数20年なので、年間減価償却費は54,000円となります。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"fixed_asset","pattern":"減価償却","accounts":["減価償却費","建物減価償却累計額"],"keywords":["減価償却","決算","建物"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "機械装置（取得原価600,000円、耐用年数10年、残存価額ゼロ）を3年前に取得した。定額法により、当期末における減価償却累計額と帳簿価額を求め、当期の減価償却費を計上する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"減価償却費","debit_amount":60000,"credit_account":"機械装置減価償却累計額","credit_amount":60000}}',
    explanation:
      "【基本概念】\n減価償却累計額は、これまでに計上した減価償却費の合計額で、帳簿価額は取得原価から減価償却累計額を差し引いた額です。\n\n【具体例・イメージ】\n機械を購入してから毎年価値が減少し、その累計額が「減価償却累計額」、残りの価値が「帳簿価額」です。\n\n【計算過程】\n年間減価償却費 = 600,000円 ÷ 10年 = 60,000円\n当期末減価償却累計額 = 60,000円 × 4年間 = 240,000円\n当期末帳簿価額 = 600,000円 - 240,000円 = 360,000円\n当期減価償却費 = 60,000円\n\n【仕訳パターン】\n減価償却費の計上：\n借方「減価償却費」、貸方「機械装置減価償却累計額」\n\n【間違えやすいポイント】\n・累計額の計算で年数を間違える\n・帳簿価額の計算式を間違える（取得原価＋累計額としてしまう）\n・当期分の減価償却費を忘れる\n\n【覚え方のコツ】\n・「累計額」は過去の合計\n・「帳簿価額」は現在の価値（取得原価－累計額）\n・毎年定額で償却する\n\n【この問題の解き方】\n年間償却費60,000円×4年間で累計額240,000円、帳簿価額360,000円となり、当期も60,000円を償却します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"fixed_asset","pattern":"減価償却","accounts":["減価償却費","機械装置減価償却累計額"],"keywords":["減価償却","累計額","帳簿価額","定額法"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "当社が2年前に取得した車両運搬具（取得原価800,000円、耐用年数8年、残存価額ゼロ、定額法）について、技術革新により耐用年数を6年に短縮することになった。決算において当期の減価償却費を計上する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"減価償却費","debit_amount":150000,"credit_account":"車両運搬具減価償却累計額","credit_amount":150000}}',
    explanation:
      "【基本概念】\n耐用年数の変更は、将来にわたって変更後の耐用年数を適用する将来適用法で処理します。過去の減価償却費は修正しません。\n\n【具体例・イメージ】\n技術の進歩により機械の陳腐化が早まったり、使用環境の変化で耐用年数が変わることがあります。\n\n【計算過程】\n変更前：年間減価償却費 = 800,000円 ÷ 8年 = 100,000円\n既計上済み：100,000円 × 2年 = 200,000円\n未償却残高：800,000円 - 200,000円 = 600,000円\n変更後の残存耐用年数：6年 - 2年 = 4年\n変更後の年間減価償却費：600,000円 ÷ 4年 = 150,000円\n\n【仕訳パターン】\n耐用年数変更後の減価償却費：\n借方「減価償却費」、貸方「車両運搬具減価償却累計額」\n\n【間違えやすいポイント】\n・過去の減価償却費を修正してしまう\n・変更前の耐用年数で継続計算してしまう\n・未償却残高を正しく計算できない\n\n【覚え方のコツ】\n・「将来適用法」で過去は修正しない\n・「未償却残高÷残存耐用年数」で新しい償却費\n・技術革新などが変更理由\n\n【この問題の解き方】\n未償却残高600,000円を残存耐用年数4年で割って、新しい年間減価償却費150,000円を計算します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"fixed_asset","pattern":"減価償却","accounts":["減価償却費","車両運搬具減価償却累計額"],"keywords":["減価償却","耐用年数変更","定額法","将来適用法"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-19T06:38:39.222Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "事務用のパソコン250,000円を購入し、代金は現金で支払った。なお、当社では30万円未満の少額減価償却資産について、取得時に全額費用処理を選択している。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"消耗品費","debit_amount":250000,"credit_account":"現金","credit_amount":250000}}',
    explanation:
      "【基本概念】\n少額減価償却資産（30万円未満）は、通常の減価償却に代えて取得年度に全額を費用として計上することができます。\n\n【具体例・イメージ】\nパソコン、プリンター、事務机など比較的安価な固定資産について、減価償却の手間を省くための特例処理です。\n\n【処理選択肢】\n1. 通常の減価償却処理（固定資産計上→毎年償却）\n2. 少額減価償却資産の特例（取得時全額費用処理）\n3. 一括償却資産（20万円未満・3年均等償却）\n\n【仕訳パターン】\n少額減価償却資産の特例適用時：\n借方「消耗品費」等、貸方「現金」等\n\n【間違えやすいポイント】\n・30万円以上でも適用してしまう\n・固定資産勘定で計上してしまう\n・必ず特例を適用しなければならないと思い込む\n\n【覚え方のコツ】\n・「30万円未満」が適用条件\n・「取得時全額費用」が特例内容\n・「選択適用」なので必須ではない\n\n【この問題の解き方】\n250,000円は30万円未満なので、少額減価償却資産の特例により取得時に全額を消耗品費として計上します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"fixed_asset","pattern":"減価償却","accounts":["消耗品費","現金"],"keywords":["少額減価償却資産","30万円未満","全額費用処理"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "機械装置（取得原価1,000,000円、耐用年数10年、残存価額ゼロ、償却率0.200）について、定率法により第1年度の減価償却費を計算して計上する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"減価償却費","debit_amount":200000,"credit_account":"機械装置減価償却累計額","credit_amount":200000}}',
    explanation:
      "【基本概念】\n定率法は、毎年一定の償却率を帳簿価額（未償却残高）に乗じて減価償却費を計算する方法です。取得初年度は償却率を取得原価に乗じます。\n\n【具体例・イメージ】\n車の価値が新車時に最も大きく下がり、年々下落幅が小さくなることをイメージしてください。機械なども初期の価値減少が大きい場合に適用されます。\n\n【計算式】\n第1年度：取得原価 × 償却率\n第2年度以降：期首帳簿価額 × 償却率\n第1年度減価償却費 = 1,000,000円 × 0.200 = 200,000円\n\n【仕訳パターン】\n定率法による減価償却費の計上：\n借方「減価償却費」、貸方「機械装置減価償却累計額」\n\n【間違えやすいポイント】\n・定額法と定率法の計算式を混同する\n・第2年度以降も取得原価を基準にしてしまう\n・償却率と耐用年数を混同する\n\n【覚え方のコツ】\n・「定率法」は毎年「一定の率」\n・初年度は「取得原価×償却率」\n・翌年度以降は「帳簿価額×償却率」\n・減価が年々「逓減」する\n\n【この問題の解き方】\n取得原価1,000,000円に償却率0.200を乗じて、第1年度の減価償却費200,000円を計算します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"fixed_asset","pattern":"減価償却","accounts":["減価償却費","機械装置減価償却累計額"],"keywords":["減価償却","定率法","償却率","機械装置"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "車両運搬具（取得原価800,000円、耐用年数5年、償却率0.400）を4月1日に取得した。定率法により、当期末（12月31日）の減価償却費を計上する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"減価償却費","debit_amount":240000,"credit_account":"車両運搬具減価償却累計額","credit_amount":240000}}',
    explanation:
      "【基本概念】\n定率法の期中取得では、月割計算により取得月から決算月までの月数に応じて減価償却費を計算します。\n\n【具体例・イメージ】\n年度途中で購入した車の減価償却は、購入月から年度末までの期間分のみ計上します。\n\n【計算過程】\n年間減価償却費 = 取得原価 × 償却率 = 800,000円 × 0.400 = 320,000円\n使用月数 = 4月～12月 = 9か月\n当期減価償却費 = 320,000円 × 9/12 = 240,000円\n\n【仕訳パターン】\n定率法による期中取得の減価償却：\n借方「減価償却費」、貸方「車両運搬具減価償却累計額」\n\n【間違えやすいポイント】\n・月割計算を忘れて年額を計上してしまう\n・取得月を含めずに計算してしまう\n・定額法と定率法の計算を混同する\n\n【覚え方のコツ】\n・「期中取得」は月割計算必須\n・取得月「から」決算月「まで」\n・定率法でも初年度は取得原価基準\n\n【この問題の解き方】\n4月取得なので使用期間は9か月、年額320,000円の9/12で240,000円となります。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"fixed_asset","pattern":"減価償却","accounts":["減価償却費","車両運搬具減価償却累計額"],"keywords":["減価償却","定率法","月割計算","期中取得"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "機械装置（取得原価1,500,000円、償却率0.250、改定取得価額750,000円、保証率0.108）について、定率法により第4年度の減価償却費を計算して計上する。前期末帳簿価額は650,000円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"減価償却費","debit_amount":162500,"credit_account":"機械装置減価償却累計額","credit_amount":162500}}',
    explanation:
      "【基本概念】\n定率法において、計算上の償却額が改定取得価額×保証率を下回る場合は、改定取得価額×保証率の額を償却します。\n\n【具体例・イメージ】\n定率法では年々償却額が減少するため、最低限の償却を保証するために保証率が設定されています。\n\n【計算過程】\n通常の計算：650,000円 × 0.250 = 162,500円\n保証額：750,000円 × 0.108 = 81,000円\n162,500円 > 81,000円なので、通常計算額162,500円を採用\n\n【仕訳パターン】\n定率法による減価償却費の計上：\n借方「減価償却費」、貸方「機械装置減価償却累計額」\n\n【間違えやすいポイント】\n・保証率との比較を忘れる\n・改定取得価額の意味を理解していない\n・通常計算と保証額計算を混同する\n\n【覚え方のコツ】\n・「保証率」は最低償却を保証\n・「改定取得価額」は保証額計算の基礎\n・通常計算と保証額の「より大きい方」を採用\n\n【この問題の解き方】\n前期末帳簿価額650,000円に償却率0.250を乗じた額と、改定取得価額750,000円に保証率0.108を乗じた額を比較します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"fixed_asset","pattern":"減価償却","accounts":["減価償却費","機械装置減価償却累計額"],"keywords":["減価償却","定率法","改定取得価額","保証率"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "機械装置（取得原価2,000,000円、償却率0.200、償却保証額100,000円）について、定率法で償却してきたが、当期の計算上の償却額が償却保証額を下回った。定額法に切り替えて当期の減価償却費を計上する。当期首帳簿価額は300,000円、残存耐用年数は3年である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"減価償却費","debit_amount":100000,"credit_account":"機械装置減価償却累計額","credit_amount":100000}}',
    explanation:
      "【基本概念】\n定率法において、計算上の償却額が償却保証額を下回った場合は、定額法に切り替えて償却します。\n\n【具体例・イメージ】\n定率法では年々償却額が減少し、最終的に償却保証額まで下がると、定額法に切り替えて残存価額まで均等償却します。\n\n【計算過程】\n定率法計算：300,000円 × 0.200 = 60,000円\n償却保証額：100,000円\n60,000円 < 100,000円なので定額法に切替\n定額法償却額 = 300,000円 ÷ 3年 = 100,000円\n\n【仕訳パターン】\n定額法切替後の減価償却費計上：\n借方「減価償却費」、貸方「機械装置減価償却累計額」\n\n【間違えやすいポイント】\n・償却保証額との比較を忘れる\n・切替後も定率法で計算してしまう\n・残存耐用年数を間違える\n\n【覚え方のコツ】\n・「償却保証額」を下回ったら定額法切替\n・切替後は「帳簿価額÷残存耐用年数」\n・定額法は「均等償却」\n\n【この問題の解き方】\n定率法計算60,000円が償却保証額100,000円を下回ったため、定額法に切り替えて帳簿価額300,000円を残存耐用年数3年で割った100,000円を償却します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"fixed_asset","pattern":"減価償却","accounts":["減価償却費","機械装置減価償却累計額"],"keywords":["減価償却","定率法","償却保証額","定額法切替"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "車両運搬具（取得原価800,000円、減価償却累計額300,000円）を600,000円で売却し、代金は現金で受け取った。",
    answer_template_json:
      '[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]',
    correct_answer_json:
      '[{"debit_account":"現金","debit_amount":600000,"credit_account":"車両運搬具","credit_amount":800000},{"debit_account":"車両運搬具減価償却累計額","debit_amount":300000,"credit_account":"固定資産売却益","credit_amount":100000}]',
    explanation:
      "【基本概念】\n固定資産の売却では、帳簿価額（取得原価-減価償却累計額）と売却価額を比較し、売却益または売却損を計上します。\n\n【具体例・イメージ】\n会社の営業車を中古車販売店に売却することをイメージしてください。購入時の価格から減価償却で減った分を差し引いた帳簿価額と、実際の売却価格を比較します。\n\n【仕訳パターン】\n・売却益の場合: 借方に現金・減価償却累計額、貸方に固定資産・固定資産売却益\n・売却損の場合: 借方に現金・減価償却累計額・固定資産売却損、貸方に固定資産\n・帳簿価額 = 取得原価 - 減価償却累計額\n\n【間違えやすいポイント】\n・減価償却累計額の仕訳を忘れる\n・帳簿価額の計算を間違える\n・売却益と売却損の判定を間違える\n・複数仕訳の借方・貸方の合計を間違える\n\n【覚え方のコツ】\n・売却時は「現金・累計額」が借方\n・「元の資産」は全額貸方\n・帳簿価額＜売却価額なら「売却益」\n・帳簿価額＞売却価額なら「売却損」\n\n【この問題の解き方】\n帳簿価額500,000円（800,000-300,000）＜売却価額600,000円なので売却益100,000円が発生。複数仕訳で処理します。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"fixed_asset_disposal","pattern":"固定資産売却益","accounts":["現金","車両運搬具","車両運搬具減価償却累計額","固定資産売却益"],"keywords":["固定資産売却","売却益","減価償却累計額","帳簿価額"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-20T11:30:00.000Z",
  },
  {
    id: "Q_J_202",
    category_id: "journal",
    question_text:
      "機械装置（取得原価1,200,000円、減価償却累計額500,000円）を400,000円で売却し、代金は現金で受け取った。",
    answer_template_json:
      '[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]',
    correct_answer_json:
      '[{"debit_account":"現金","debit_amount":400000,"credit_account":"機械装置","credit_amount":1200000},{"debit_account":"機械装置減価償却累計額","debit_amount":500000,"credit_account":"固定資産売却損","credit_amount":300000}]',
    explanation:
      "【基本概念】\n固定資産の売却で帳簿価額よりも売却価額が低い場合、その差額を固定資産売却損として計上します。\n\n【具体例・イメージ】\n古くなった機械を中古機械店に売却することをイメージしてください。減価償却で減ったとはいえ、実際の売却価格が帳簿価額よりも低くなることがあります。\n\n【仕訳パターン】\n・売却損の場合: 借方に現金・減価償却累計額・固定資産売却損、貸方に固定資産\n・帳簿価額 = 取得原価 - 減価償却累計額\n・売却損 = 帳簿価額 - 売却価額\n\n【間違えやすいポイント】\n・減価償却紬計額の仕訳を忘れる\n・帳簿価額の計算を間違える\n・売却損の金額計算を間違える\n・複数仕訳の借方・貸方の合計を間違える\n\n【覚え方のコツ】\n・売却時は「現金・累計額・損」が借方\n・「元の資産」は全額貸方\n・帳簿価額＞売却価額なら「売却損」\n・売却損は「特別損失」ではなく「営業外費用」\n\n【この問題の解き方】\n帳簿価額700,000円（1,200,000-500,000）＞売却価額400,000円なので売却損300,000円が発生。複数仕訳で処理します。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"fixed_asset_disposal","pattern":"固定資産売却損","accounts":["現金","機械装置","機械装置減価償却累計額","固定資産売却損"],"keywords":["固定資産売却","売却損","減価償却累計額","帳簿価額"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-20T11:30:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "8月1日に取得した車両運搬具（取得原価600,000円、耐用年数5年、残存価額ゼロ）の一部を、11月1日に売却した。売却日までの減価償却費を計上する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"減価償却費","debit_amount":30000,"credit_account":"車両運搬具減価償却累計額","credit_amount":30000}}',
    explanation:
      "【基本概念】\n固定資産を期中に売却する場合、売却日までの減価償却費を月割り計算で計上してから、売却仕訳を行います。\n\n【具体例・イメージ】\n会社の営業車を年途中に売却することをイメージしてください。その年の1月から売却月までの減価償却費を計算して計上します。\n\n【仕訳パターン】\n・月割り減価償却費計上: 借方に減価償却費、貸方に減価償却累計額\n・計算式: 年間減価償却費×使用月数÷12\n・年間減価償却費 = (取得原価-残存価額)÷耐用年数\n\n【間違えやすいポイント】\n・月割り計算を忘れる\n・使用月数の数え方を間違える\n・売却日までの減価償却を忘れる\n・年間減価償却費の計算を間違える\n\n【覚え方のコツ】\n・期中売却は「売却日まで償却」\n・月数は「使用開始から売却日まで」\n・月割り計算は「年間償却費×月数÷12」\n・売却前に「必ず減価償却計上」\n\n【この問題の解き方】\n年間減価償却費120,000円（600,000÷5）、使用月数3か月（8月〜11月）なので、120,000×3÷12=30,000円を計上します。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"fixed_asset_disposal","pattern":"期中売却減価償却","accounts":["減価償却費","車両運搬具減価償却累計額"],"keywords":["期中売却","月割り計算","減価償却費","売却日"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-20T11:30:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "建物（帳簿価額2,400,000円）を3,000,000円で売却し、代金のうち1,500,000円は現金で受け取り、残額1,500,000円は6か月後に受け取ることになった。",
    answer_template_json:
      '[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]',
    correct_answer_json:
      '[{"debit_account":"現金","debit_amount":1500000,"credit_account":"建物","credit_amount":2400000},{"debit_account":"未収入金","debit_amount":1500000,"credit_account":"固定資産売却益","credit_amount":600000}]',
    explanation:
      "【基本概念】\n固定資産の売却代金を分割回収する場合、受け取り方法に応じて適切な債権勘定を使用します。即金部分は現金、後日受取分は未収入金で処理します。\n\n【具体例・イメージ】\n建物を売却する際、買主が「頭金と残金の分割払い」を希望する場合をイメージしてください。頭金は現金で受取り、残金は将来の債権として計上します。\n\n【仕訳パターン】\n・即金受取分: 借方に現金\n・後日受取分: 借方に未収入金\n・簿価除去: 貸方に固定資産（帳簿価額）\n・売却損益: 売却価額-帳簿価額（益なら貸方、損なら借方）\n\n【間違えやすいポイント】\n・後日受取分を売掛金で処理してしまう\n・売却損益の計算を間違える\n・分割受取の債権勘定を忘れる\n・帳簿価額と売却価額を混同する\n\n【覚え方のコツ】\n・営業外債権は「未収入金」\n・売掛金は「商品売上」専用\n・固定資産売却は「営業外取引」\n・分割回収でも「売却時点で損益確定」\n\n【この問題の解き方】\n売却価額3,000,000円から帳簿価額2,400,000円を差し引いて売却益600,000円を計算し、現金1,500,000円と未収入金1,500,000円で代金回収を処理します。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"fixed_asset_disposal","pattern":"割賦売却","accounts":["現金","未収入金","建物","固定資産売却益"],"keywords":["分割回収","割賦売却","未収入金","売却益"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-20T11:35:00.000Z",
  },
  {
    id: "Q_J_205",
    category_id: "journal",
    question_text:
      "旧型車両運搬具（帳簿価額800,000円）を新型車両運搬具（1,200,000円）と交換し、差金400,000円を現金で支払った。",
    answer_template_json:
      '[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]',
    correct_answer_json:
      '[{"debit_account":"車両運搬具","debit_amount":1200000,"credit_account":"車両運搬具","credit_amount":800000},{"debit_account":"","debit_amount":0,"credit_account":"現金","credit_amount":400000}]',
    explanation:
      "【基本概念】\n固定資産の交換取引では、新資産の取得と旧資産の引渡し、さらに交換差金の授受が同時に発生します。簿記3級では等価交換として処理し、損益は計上しません。\n\n【具体例・イメージ】\n古い営業車を新しい営業車に買い替える際、下取り価格と新車価格の差額を現金で支払う場合をイメージしてください。\n\n【仕訳パターン】\n・新資産取得: 借方に新固定資産（時価または簿価+差金）\n・旧資産引渡: 貸方に旧固定資産（帳簿価額）\n・差金支払: 貸方に現金（支払差金）\n・差金受取: 借方に現金（受取差金）\n\n【間違えやすいポイント】\n・交換損益を計上してしまう\n・新資産の金額を時価でなく簿価で計上する\n・差金の方向（支払・受取）を間違える\n・複合仕訳の構造を理解できない\n\n【覚え方のコツ】\n・簿記3級では「等価交換」処理\n・新資産は「時価」で取得\n・差金は「時価-簿価」の調整\n・損益計上は「しない」\n\n【この問題の解き方】\n新車両1,200,000円を借方計上、旧車両800,000円を貸方計上、差金400,000円を現金で貸方計上します。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"fixed_asset_disposal","pattern":"固定資産交換","accounts":["車両運搬具","現金"],"keywords":["固定資産交換","交換差金","等価交換","下取り"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "車両運搬具（帳簿価額900,000円）を1,100,000円（税込み）で売却し、代金は現金で受け取った。消費税率は10%とする。",
    answer_template_json:
      '[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]',
    correct_answer_json:
      '[{"debit_account":"現金","debit_amount":1100000,"credit_account":"車両運搬具","credit_amount":900000},{"debit_account":"","debit_amount":0,"credit_account":"固定資産売却益","credit_amount":100000},{"debit_account":"","debit_amount":0,"credit_account":"仮受消費税","credit_amount":100000}]',
    explanation:
      "【基本概念】\n固定資産の売却時には、売却価額に消費税が含まれている場合、本体価額と消費税を区分して仕訳処理を行います。固定資産の売却は課税売上となります。\n\n【具体例・イメージ】\n会社の営業車を中古車販売店に売却する場合をイメージしてください。売却価格には消費税が含まれているため、税抜き価格で売却損益を計算し、消費税部分は仮受消費税で処理します。\n\n【仕訳パターン】\n・現金受取: 借方に現金（税込み売却価額）\n・資産除去: 貸方に固定資産（帳簿価額）\n・売却損益: 税抜売却価額-帳簿価額（益なら貸方、損なら借方）\n・消費税処理: 貸方に仮受消費税（売却価額×10/110）\n\n【間違えやすいポイント】\n・消費税の区分処理を忘れる\n・税込み価格で売却損益を計算してしまう\n・仮受消費税の計算を間違える\n・土地の売却は非課税だが車両は課税売上\n\n【覚え方のコツ】\n・固定資産売却は「課税売上」\n・土地売却は「非課税」（例外）\n・税抜き価格で「損益計算」\n・消費税は「仮受消費税」で処理\n\n【この問題の解き方】\n税込み1,100,000円から消費税100,000円を除いた税抜き1,000,000円と帳簿価額900,000円の差額100,000円が売却益となります。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"fixed_asset_disposal","pattern":"消費税課税売上","accounts":["現金","車両運搬具","固定資産売却益","仮受消費税"],"keywords":["消費税","課税売上","税込価格","仮受消費税"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-20T11:45:00.000Z",
  },
  {
    id: "Q_J_207",
    category_id: "journal",
    question_text:
      "使用不能となった備品（取得原価800,000円、減価償却累計額600,000円）を除却した。",
    answer_template_json:
      '[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]',
    correct_answer_json:
      '[{"debit_account":"備品減価償却累計額","debit_amount":600000,"credit_account":"備品","credit_amount":800000},{"debit_account":"固定資産除却損","debit_amount":200000,"credit_account":"","credit_amount":0}]',
    explanation:
      "【基本概念】\n固定資産の除却とは、老朽化・故障・技術的陳腐化等により使用不能となった固定資産を帳簿から除去することです。帳簿価額が残る場合は除却損として費用計上します。\n\n【具体例・イメージ】\n古いパソコンや機械が故障して修理不能になり、廃棄処分する場合をイメージしてください。資産価値がゼロになったため、残存する帳簿価額を損失として計上します。\n\n【仕訳パターン】\n・減価償却累計額: 借方に累計額（累計償却額）\n・固定資産除去: 貸方に固定資産（取得原価）\n・除却損計上: 借方に固定資産除却損（帳簿価額）\n・帳簿価額 = 取得原価 - 減価償却累計額\n\n【間違えやすいポイント】\n・除却損の金額計算を間違える\n・減価償却累計額の処理を忘れる\n・売却と除却の処理を混同する\n・帳簿価額がゼロの場合の処理\n\n【覚え方のコツ】\n・除却は「廃棄・処分」（対価なし）\n・売却は「譲渡・換金」（対価あり）\n・除却損は「帳簿価額」分\n・累計額は「必ず整理」\n\n【この問題の解き方】\n取得原価800,000円から減価償却累計額600,000円を差し引いた帳簿価額200,000円が除却損となります。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"fixed_asset_disposal","pattern":"固定資産除却","accounts":["備品減価償却累計額","備品","固定資産除却損"],"keywords":["除却","除却損","使用不能","帳簿価額"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-20T11:50:00.000Z",
  },
  {
    id: "Q_J_208",
    category_id: "journal",
    question_text:
      "老朽化した機械装置（取得原価1,500,000円、減価償却累計額1,200,000円）を廃棄し、解体・処分費用50,000円を現金で支払った。",
    answer_template_json:
      '[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]',
    correct_answer_json:
      '[{"debit_account":"機械装置減価償却累計額","debit_amount":1200000,"credit_account":"機械装置","credit_amount":1500000},{"debit_account":"固定資産除却損","debit_amount":300000,"credit_account":"","credit_amount":0},{"debit_account":"固定資産除却損","debit_amount":50000,"credit_account":"現金","credit_amount":50000}]',
    explanation:
      "【基本概念】\n固定資産の廃棄時には、資産の除去処理に加えて解体・撤去・処分費用が発生することがあります。これらの費用も固定資産除却損として計上します。\n\n【具体例・イメージ】\n古い工場の機械を廃棄する際、業者に解体・撤去を依頼し、処分費用を支払う場合をイメージしてください。機械自体の帳簿価額に加えて、処分費用も損失となります。\n\n【仕訳パターン】\n・減価償却累計額: 借方に累計額（累計償却額）\n・固定資産除去: 貸方に固定資産（取得原価）\n・帳簿価額の除却損: 借方に固定資産除却損（帳簿価額）\n・処分費用: 借方に固定資産除却損、貸方に現金\n\n【間違えやすいポイント】\n・処分費用を別勘定で処理してしまう\n・帳簿価額と処分費用を合算し忘れる\n・除却損の金額計算を間違える\n・廃棄と売却の処理を混同する\n\n【覚え方のコツ】\n・廃棄は「対価なし」の処分\n・処分費用も「除却損」に含む\n・除却損 = 帳簿価額 + 処分費用\n・現金支払いは「費用の追加」\n\n【この問題の解き方】\n帳簿価額300,000円（1,500,000-1,200,000）と処分費用50,000円の合計350,000円が固定資産除却損となります。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"fixed_asset_disposal","pattern":"廃棄処分費用","accounts":["機械装置減価償却累計額","機械装置","固定資産除却損","現金"],"keywords":["廃棄","処分費用","解体費用","除却損"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-20T11:55:00.000Z",
  },
  {
    id: "Q_J_209",
    category_id: "journal",
    question_text:
      "地震により工場建物（取得原価5,000,000円、減価償却累計額3,000,000円）が全壊した。建物に対する火災保険金1,500,000円が後日支払われることになった。",
    answer_template_json:
      '[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]',
    correct_answer_json:
      '[{"debit_account":"建物減価償却累計額","debit_amount":3000000,"credit_account":"建物","credit_amount":5000000},{"debit_account":"未収入金","debit_amount":1500000,"credit_account":"","credit_amount":0},{"debit_account":"災害損失","debit_amount":500000,"credit_account":"","credit_amount":0}]',
    explanation:
      "【基本概念】\n災害により固定資産が滅失・損傷した場合、資産の除去処理を行い、保険金等で補填されない部分を災害損失として計上します。災害損失は特別損失として処理されます。\n\n【具体例・イメージ】\n地震や火災で工場や事務所が被害を受けた場合をイメージしてください。建物が全壊しても保険金で全額は補償されず、差額が会社の損失となります。\n\n【仕訳パターン】\n・減価償却累計額: 借方に累計額（累計償却額）\n・固定資産除去: 貸方に固定資産（取得原価）\n・保険金請求: 借方に未収入金（保険金額）\n・災害損失: 借方に災害損失（帳簿価額-保険金）\n\n【間違えやすいポイント】\n・災害損失の計算を間違える\n・保険金を現金で処理してしまう\n・特別損失としての性質を理解していない\n・全額が災害損失になると考えてしまう\n\n【覚え方のコツ】\n・災害損失は「特別損失」\n・保険金は「未収入金」（後日受取）\n・損失額 = 帳簿価額 - 保険金\n・自然災害は「予測不可能」\n\n【この問題の解き方】\n帳簿価額2,000,000円（5,000,000-3,000,000）から保険金1,500,000円を差し引いた500,000円が災害損失となります。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"fixed_asset_disposal","pattern":"災害損失","accounts":["建物減価償却累計額","建物","未収入金","災害損失"],"keywords":["災害","地震","保険金","災害損失","特別損失"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "老朽化した建物（取得原価8,000,000円、減価償却累計額7,500,000円）を取り壊し、解体費用200,000円を現金で支払った。なお、解体で発生したスクラップ30,000円を現金で売却した。",
    answer_template_json:
      '[{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0},{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}]',
    correct_answer_json:
      '[{"debit_account":"建物減価償却累計額","debit_amount":7500000,"credit_account":"建物","credit_amount":8000000},{"debit_account":"固定資産除却損","debit_amount":500000,"credit_account":"","credit_amount":0},{"debit_account":"固定資産除却損","debit_amount":200000,"credit_account":"現金","credit_amount":200000},{"debit_account":"現金","debit_amount":30000,"credit_account":"固定資産除却損","credit_amount":30000}]',
    explanation:
      "【基本概念】\n固定資産の取壊し・解体時には、資産の除去処理、解体費用の負担、さらにスクラップ等の処分収入が発生することがあります。これらは全て固定資産除却損勘定で処理します。\n\n【具体例・イメージ】\n古い建物を解体して新築する場合をイメージしてください。解体業者への支払い、スクラップの売却収入、建物の帳簿価額すべてが関連する取引となります。\n\n【仕訳パターン】\n・減価償却累計額: 借方に累計額（累計償却額）\n・固定資産除去: 貸方に固定資産（取得原価）\n・帳簿価額: 借方に固定資産除却損（帳簿価額）\n・解体費用: 借方に固定資産除却損、貸方に現金\n・処分収入: 借方に現金、貸方に固定資産除却損\n\n【間違えやすいポイント】\n・解体費用を修繕費で処理してしまう\n・スクラップ収入を雑収入で処理してしまう\n・取壊しに関する費用・収入は全て除却損で処理\n・正味の除却損額を計算し間違える\n\n【覚え方のコツ】\n・取壊し関連は「全て除却損」\n・解体費用は「除却損増加」\n・処分収入は「除却損減少」\n・正味損失 = 帳簿価額 + 費用 - 収入\n\n【この問題の解き方】\n帳簿価額500,000円に解体費用200,000円を加え、スクラップ収入30,000円を差し引いた正味670,000円が固定資産除却損となります。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"fixed_asset_disposal","pattern":"取壊し解体費用","accounts":["建物減価償却累計額","建物","固定資産除却損","現金"],"keywords":["取壊し","解体費用","スクラップ","除却損","解体"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-20T12:05:00.000Z",
  },
  {
    id: "Q_J_211",
    category_id: "journal",
    question_text:
      "決算において、売掛金残高800,000円に対して3%の貸倒引当金を設定する。なお、前期末の貸倒引当金残高は18,000円である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"貸倒引当金繰入","debit_amount":6000,"credit_account":"貸倒引当金","credit_amount":6000}}',
    explanation:
      "【基本概念】\n貸倒引当金の差額補充法とは、期末に必要な引当金額と期首残高の差額のみを繰入・戻入する方法です。簿記3級では最も一般的な処理方法となります。\n\n【具体例・イメージ】\n銀行の融資審査で、貸出先の信用リスクに応じて引当金を積む場合をイメージしてください。前年から引当金があっても、今年の必要額との差額だけを調整します。\n\n【仕訳パターン】\n・必要額の計算: 債権残高×引当率\n・差額補充法: 必要額-前期末残高=当期繰入額\n・繰入時: 借方に貸倒引当金繰入、貸方に貸倒引当金\n・戻入時: 借方に貸倒引当金、貸方に貸倒引当金戻入\n\n【間違えやすいポイント】\n・必要額全額を繰入してしまう（洗替法と混同）\n・前期末残高を考慮し忘れる\n・計算式を間違える\n・戻入の場合の仕訳を逆にする\n\n【覚え方のコツ】\n・差額補充法は「足りない分だけ追加」\n・必要額800,000×3%=24,000円\n・差額24,000-18,000=6,000円を繰入\n・「不足分補充」が基本原理\n\n【この問題の解き方】\n必要引当金額24,000円（800,000×3%）から前期末残高18,000円を差し引いた6,000円を貸倒引当金繰入として計上します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"year_end_adjustment","pattern":"貸倒引当金差額補充法","accounts":["貸倒引当金繰入","貸倒引当金"],"keywords":["貸倒引当金","差額補充法","売掛金","引当率"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.368Z",
    updated_at: "2025-08-20T12:10:00.000Z",
  },
  {
    id: "Q_J_212",
    category_id: "journal",
    question_text:
      "前期末に設定した貸倒引当金30,000円について、当期の必要額が25,000円となった。差額補充法により貸倒引当金を調整する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"貸倒引当金","debit_amount":5000,"credit_account":"貸倒引当金戻入","credit_amount":5000}}',
    explanation:
      "【基本概念】\n貸倒引当金の戻入れとは、前期末に設定した引当金額が当期の必要額を上回る場合に、その超過分を戻入れ（収益計上）する処理です。差額補充法では過剰分のみを戻入れします。\n\n【具体例・イメージ】\n企業の債権回収状況が改善し、前年よりも貸倒れリスクが減少した場合をイメージしてください。設定済みの引当金が多すぎるため、超過分を収益として戻入れます。\n\n【仕訳パターン】\n・戻入時：借方に貸倒引当金、貸方に貸倒引当金戻入\n・戻入額の計算：前期末残高－当期必要額＝戻入額\n・貸倒引当金戻入は営業外収益として計上\n・差額補充法では超過分のみを戻入れ\n\n【間違えやすいポイント】\n・必要額全体を戻入れしてしまう（洗替法と混同）\n・借方・貸方を逆にする\n・貸倒引当金戻入を費用として処理\n・計算式を間違える\n\n【覚え方のコツ】\n・戻入れは「引当金を減らして収益を増やす」\n・差額補充法は「超過分だけ戻す」\n・前期末30,000円－当期必要25,000円＝戻入5,000円\n・「過剰分返却」が基本原理\n\n【この問題の解き方】\n前期末残高30,000円から当期必要額25,000円を差し引いた5,000円を貸倒引当金戻入として収益計上します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"year_end_adjustment","pattern":"貸倒引当金戻入","accounts":["貸倒引当金","貸倒引当金戻入"],"keywords":["貸倒引当金","戻入","差額補充法","引当金調整"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "当期末に売掛金20,000円が貸倒れとなった。貸倒引当金残高は15,000円である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"貸倒引当金","debit_amount":15000,"credit_account":"売掛金","credit_amount":15000}}',
    explanation:
      "【基本概念】\n実際の貸倒れが発生した場合、まず貸倒引当金を充当し、不足分を貸倒損失として計上します。これは引当金の本来の目的である「将来の損失への備え」を実現する処理です。\n\n【具体例・イメージ】\n取引先が倒産して売掛金が回収不能になった場合をイメージしてください。あらかじめ積み立てた引当金で対応し、足りない分は臨時の損失として処理します。\n\n【仕訳パターン】\n・引当金充当：借方に貸倒引当金、貸方に売掛金\n・不足分処理：借方に貸倒損失、貸方に売掛金\n・複合仕訳：引当金充当分と損失分を同時処理\n・引当金が十分な場合：引当金のみで処理\n\n【間違えやすいポイント】\n・全額を貸倒損失で処理してしまう\n・引当金を使わず全額損失計上\n・複合仕訳の金額配分を間違える\n・売掛金を減額しない\n\n【覚え方のコツ】\n・まず引当金を使い切る\n・足りない分は損失処理\n・引当金20,000円→損失5,000円の順で処理\n・「備えを使って、足りない分は追加損失」\n\n【この問題の解き方】\n貸倒金額20,000円のうち、引当金15,000円で充当する仕訳を行います。（不足分5,000円は別途貸倒損失で処理）",
    difficulty: 3,
    tags_json:
      '{"subcategory":"year_end_adjustment","pattern":"貸倒引当金充当","accounts":["貸倒引当金","売掛金","貸倒損失"],"keywords":["貸倒引当金","実際貸倒","引当金充当","売掛金"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "前期に貸倒損失で処理した売掛金12,000円について、当期に現金で回収された。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金","debit_amount":12000,"credit_account":"償却債権取立益","credit_amount":12000}}',
    explanation:
      "【基本概念】\n償却債権取立益とは、過去に貸倒損失で処理（償却）した債権が予想に反して回収された場合に計上する特別利益です。一度諦めた債権の回収なので、営業外収益として処理します。\n\n【具体例・イメージ】\n倒産したと思っていた取引先が業績回復し、過去の未払い代金を支払ってきた場合をイメージしてください。予想外の嬉しい収入として特別に利益計上します。\n\n【仕訳パターン】\n・償却債権回収時：借方に現金、貸方に償却債権取立益\n・営業外収益として損益計算書に計上\n・過去の貸倒損失とは別の会計期間の取引\n・回収額全額が利益となる\n\n【間違えやすいポイント】\n・売掛金勘定を復活させてしまう\n・貸倒引当金戻入と混同する\n・営業収益（売上）として処理してしまう\n・過去の貸倒損失を取り消そうとする\n\n【覚え方のコツ】\n・「償却」＝過去に処理済み\n・「取立益」＝予想外の利益\n・現金12,000円→償却債権取立益12,000円\n・「死んだ債権が生き返った」イメージ\n\n【この問題の解き方】\n過去に貸倒損失処理した債権12,000円の回収なので、全額を償却債権取立益として営業外収益に計上します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"special_transaction","pattern":"償却債権取立益","accounts":["現金","償却債権取立益"],"keywords":["償却債権取立益","貸倒損失","債権回収","営業外収益"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "売掛金の貸倒引当金設定にあたり、A社向け売掛金50,000円（破綻懸念先）については50%、その他一般債権150,000円については3%の引当率で設定する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"貸倒引当金繰入","debit_amount":29500,"credit_account":"貸倒引当金","credit_amount":29500}}',
    explanation:
      "【基本概念】\n個別引当金と一般引当金とは、債権の信用状態に応じて異なる引当率を適用する方法です。個別引当金は特定の破綻懸念先等への高リスク債権、一般引当金は通常の取引先への標準的債権に適用します。\n\n【具体例・イメージ】\n銀行の融資審査をイメージしてください。経営困難な会社（個別）には高い引当率、健全な会社（一般）には低い引当率を設定して、リスクに応じた備えを行います。\n\n【仕訳パターン】\n・個別引当金：破綻懸念先等への高率引当（50%等）\n・一般引当金：正常先への低率引当（1-5%等）\n・合算処理：個別＋一般の合計額で繰入計上\n・リスク別管理：債権の信用度に応じた区分設定\n\n【間違えやすいポイント】\n・個別と一般を混同して同率適用\n・計算を別々に行わず合計を誤る\n・破綻懸念先を一般引当で処理\n・引当率の適用対象を間違える\n\n【覚え方のコツ】\n・個別引当金＝特別にヤバい先（高率）\n・一般引当金＝普通の取引先（低率）\n・個別50,000×50%＋一般150,000×3%＝25,000＋4,500＝29,500円\n・「特別扱い＋一般扱い」の合算\n\n【この問題の解き方】\nA社50,000円×50%＝25,000円、その他150,000円×3%＝4,500円の合計29,500円を貸倒引当金繰入として計上します。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"year_end_adjustment","pattern":"個別一般引当金","accounts":["貸倒引当金繰入","貸倒引当金"],"keywords":["個別引当金","一般引当金","破綻懸念先","引当率"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-19T06:38:39.244Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "貸付金100,000円に対して、過去の実績により貸倒引当金を2%設定する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"貸倒引当金繰入","debit_amount":2000,"credit_account":"貸倒引当金","credit_amount":2000}}',
    explanation:
      "【基本概念】\n売上債権以外の債権（貸付金、従業員貸付金、差入保証金等）に対しても、貸倒れの可能性がある場合は貸倒引当金を設定する必要があります。引当金の計算方法は売上債権と同様です。\n\n【具体例・イメージ】\n従業員への貸付金や取引先への貸付金に対して、過去の貸倒実績や取引先の信用状況を考慮して引当金を設定します。100,000円の貸付金に2%の引当率を適用すると2,000円の引当金となります。\n\n【仕訳パターン】\n・引当金設定時: （借）貸倒引当金繰入 ××× （貸）貸倒引当金 ×××\n・引当金戻入時: （借）貸倒引当金 ××× （貸）貸倒引当金戻入 ×××\n・実際貸倒時: （借）貸倒引当金 ××× （貸）貸付金 ×××\n・不足分処理: （借）貸倒損失 ××× （貸）貸付金 ×××\n\n【間違えやすいポイント】\n・売上債権の引当金と区別せずに計算してしまう\n・貸付金の性質（短期・長期、担保の有無）を考慮しない\n・引当率の根拠（過去実績、信用調査等）を理解していない\n・勘定科目を間違える（貸倒引当金繰入と貸倒損失の区別）\n\n【覚え方のコツ】\n・「債権あるところ引当金あり」の原則\n・引当率＝過去の貸倒実績や信用状況に基づく\n・設定時は費用計上、戻入時は収益計上\n・実際貸倒時は引当金から充当、不足分は損失計上\n\n【この問題の解き方】\n1. 貸付金残高100,000円を確認\n2. 引当率2%を適用: 100,000円×2%=2,000円\n3. 貸倒引当金繰入（費用）2,000円と貸倒引当金（負債）2,000円で仕訳",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"引当金","accounts":["貸倒引当金繰入","貸倒引当金","貸付金"],"keywords":["貸倒引当金","貸付金","引当率","債権以外"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "売掛金残高800,000円に対して、過去3年間の貸倒実績率1.5%に基づいて貸倒引当金を設定する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"貸倒引当金繰入","debit_amount":12000,"credit_account":"貸倒引当金","credit_amount":12000}}',
    explanation:
      "【基本概念】\n貸倒実績率による引当金設定は、過去の実際の貸倒損失の実績データに基づいて引当率を算定する方法です。過去3〜5年程度の実績を平均して引当率を決定することが一般的です。\n\n【具体例・イメージ】\n過去3年間で売掛金総額に対して平均1.5%の貸倒れが発生している場合、今期末の売掛金に対しても同程度の貸倒れが見込まれるため、800,000円×1.5%=12,000円の引当金を設定します。\n\n【仕訳パターン】\n・実績率による設定: （借）貸倒引当金繰入 ××× （貸）貸倒引当金 ×××\n・翌期戻入処理: （借）貸倒引当金 ××× （貸）貸倒引当金戻入 ×××\n・実際貸倒発生: （借）貸倒引当金 ××× （貸）売掛金 ×××\n・差額補充法適用: 期末必要額から期首残高を控除した差額を繰入\n\n【間違えやすいポイント】\n・実績率の計算期間を間違える（通常3〜5年間）\n・洗替法と差額補充法を混同する\n・期首残高がある場合の差額計算を忘れる\n・債権の種類別（売掛金・受取手形等）の実績率を区別しない\n\n【覚え方のコツ】\n・実績率＝過去の貸倒損失額÷過去の売上債権平均残高\n・「過去は未来の鏡」実績に基づく合理的な見積り\n・期首残高がある場合は差額補充が原則\n・実績率は毎期見直し、適切性を検証\n\n【この問題の解き方】\n1. 売掛金残高800,000円を確認\n2. 過去の実績率1.5%を適用\n3. 必要引当金額: 800,000円×1.5%=12,000円\n4. 貸倒引当金繰入12,000円で仕訳計上",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"引当金","accounts":["貸倒引当金繰入","貸倒引当金","売掛金"],"keywords":["貸倒実績率","過去実績","引当率算定","差額補充法"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "売掛金600,000円に対して、税法で認められる法定繰入率0.5%で貸倒引当金を設定する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"貸倒引当金繰入","debit_amount":3000,"credit_account":"貸倒引当金","credit_amount":3000}}',
    explanation:
      "【基本概念】\n法定繰入率による引当金は、税法で認められている繰入限度額の範囲内で設定する引当金です。法人税法で業種別に定められた繰入率（通常0.3〜1.0%程度）を上限として損金算入が認められます。\n\n【具体例・イメージ】\n小売業の場合、税法で認められる法定繰入率が0.5%と定められている場合、売掛金600,000円に対して最大3,000円（600,000円×0.5%）まで税務上の損金として引当金を設定できます。\n\n【仕訳パターン】\n・法定繰入率適用: （借）貸倒引当金繰入 ××× （貸）貸倒引当金 ×××\n・限度額超過分: 税務上損金不算入（会計上は費用）\n・翌期戻入: （借）貸倒引当金 ××× （貸）貸倒引当金戻入 ×××\n・税務調整: 法定限度額超過分は申告調整で加算\n\n【間違えやすいポイント】\n・会計上の引当金と税法上の引当金を混同する\n・業種別の法定繰入率を間違える\n・期首残高がある場合の限度額計算を誤る\n・損金算入限度額を超えた部分の税務処理を忘れる\n\n【覚え方のコツ】\n・法定繰入率＝税法で定められた上限の引当率\n・「税務は保守的」過大な引当金計上を制限\n・会計基準＞税法基準の場合は申告調整必要\n・業種により繰入率が異なる（製造業、小売業等）\n\n【この問題の解き方】\n1. 売掛金残高600,000円を確認\n2. 法定繰入率0.5%を適用\n3. 引当金額: 600,000円×0.5%=3,000円\n4. 貸倒引当金繰入3,000円で仕訳計上",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"引当金","accounts":["貸倒引当金繰入","貸倒引当金","売掛金"],"keywords":["法定繰入率","税法基準","損金算入","繰入限度額"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "決算において、従業員の夏季賞与支給予定額240,000円に対して賞与引当金を設定する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"賞与引当金繰入","debit_amount":240000,"credit_account":"賞与引当金","credit_amount":240000}}',
    explanation:
      "【基本概念】\n賞与引当金は、翌期に支給予定の賞与のうち当期の労働に対応する部分を当期の費用として計上するための引当金です。期間損益計算の適正化と費用収益対応原則に基づいて設定します。\n\n【具体例・イメージ】\n7月支給の夏季賞与のうち、4〜6月分の労働対価部分（通常は全額）を3月決算時に引当金として計上します。240,000円の夏季賞与支給予定がある場合、この全額を引当金として設定します。\n\n【仕訳パターン】\n・引当金設定: （借）賞与引当金繰入 ××× （貸）賞与引当金 ×××\n・賞与支給時: （借）賞与引当金 ××× （貸）現金預金 ×××\n・差額処理: 実際支給額との差額は賞与として追加計上\n・翌期戻入: 洗替法の場合は全額戻入\n\n【間違えやすいポイント】\n・賞与支給時の引当金取崩を忘れる\n・当期対応分と翌期対応分を区別しない\n・社会保険料の会社負担分を含めない\n・支給予定額の変更時の調整を忘れる\n\n【覚え方のコツ】\n・「働いた分は当期の費用」期間対応の原則\n・設定時は費用計上、支給時は引当金取崩\n・賞与＝労働の対価、期間で按分が基本\n・社会保険料も含めて引当金設定が実務的\n\n【この問題の解き方】\n1. 夏季賞与支給予定額240,000円を確認\n2. 決算時点で全額を当期の費用として認識\n3. 賞与引当金繰入（費用）240,000円を計上\n4. 賞与引当金（負債）240,000円を設定",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"引当金","accounts":["賞与引当金繰入","賞与引当金"],"keywords":["賞与引当金","従業員賞与","期間対応","費用収益対応"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "決算において、機械装置の定期修繕費用として年間180,000円の修繕引当金を設定する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"修繕引当金繰入","debit_amount":180000,"credit_account":"修繕引当金","credit_amount":180000}}',
    explanation:
      "【基本概念】\n修繕引当金は、固定資産の定期的な修繕に備えて設定する引当金です。大型設備の定期点検費用や建物の大規模修繕費用など、周期的に発生する修繕費用を期間配分するために使用します。\n\n【具体例・イメージ】\n工場の機械装置は3年に1回大規模メンテナンスで540,000円かかる場合、年間180,000円ずつ修繕引当金を積み立てます。船舶のドック入り費用や建物の外壁修繕なども同様の考え方です。\n\n【仕訳パターン】\n・引当金設定: （借）修繕引当金繰入 ××× （貸）修繕引当金 ×××\n・修繕実施時: （借）修繕引当金 ××× （貸）現金預金 ×××\n・不足時処理: （借）修繕費 ××× （貸）現金預金 ×××\n・余剰時処理: （借）修繕引当金 ××× （貸）修繕引当金戻入 ×××\n\n【間違えやすいポイント】\n・通常の修繕費と大規模修繕の区別をしない\n・修繕実施時の引当金取崩を忘れる\n・毎期均等額の設定原則を理解していない\n・税法上の取扱い（損金算入要件）を考慮しない\n\n【覚え方のコツ】\n・「大きな修繕は計画的に」均等配分の原則\n・設定時は費用計上、実施時は引当金取崩\n・定期修繕＝予測可能、引当金で対応\n・突発修繕＝予測困難、発生時に費用計上\n\n【この問題の解き方】\n1. 年間修繕引当金設定額180,000円を確認\n2. 当期の費用として修繕引当金繰入を計上\n3. 将来の修繕支出に備えて修繕引当金を設定\n4. 借方：修繕引当金繰入、貸方：修繕引当金で仕訳",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"引当金","accounts":["修繕引当金繰入","修繕引当金"],"keywords":["修繕引当金","定期修繕","固定資産","期間配分"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    explanation:
      "【基本概念】\n前払費用は、既に代金を支払ったが、まだサービスを受けていない部分を資産として計上する経過勘定項目です。期間損益計算の適正化のため、当期分と次期分を正確に区分する必要があります。\n\n【具体例・イメージ】\n1年分の保険料500円を期首に支払った場合、決算時点で残り期間（次期分）300円分はまだサービスを受けていない前払分として資産計上します。借りているオフィスの家賃を前払いした場合も同様です。\n\n【仕訳パターン】\n・決算時調整: （借）前払費用 ××× （貸）保険料 ×××\n・翌期首戻入: （借）保険料 ××× （貸）前払費用 ×××\n・翌期中取崩: サービス消費に応じて費用計上\n・期中支払時: （借）保険料 ××× （貸）現金 ×××\n\n【間違えやすいポイント】\n・当期分と次期分の期間按分計算を間違える\n・前払費用（資産）と未払費用（負債）を混同する\n・翌期首の再振替仕訳を忘れる\n・月割計算での端数処理を間違える\n\n【覚え方のコツ】\n・「前払」=「先に払った」=「権利」=資産\n・期間按分は「月数÷12ヶ月」で計算\n・決算整理で次期分を資産計上、翌期首で戻入\n・前払費用は貸借対照表の資産の部に計上\n\n【この問題の解き方】\n1. 支払保険料総額500円を確認\n2. 次期分300円を前払費用として資産計上\n3. 当期費用は200円（500円-300円）\n4. 仕訳：（借）前払費用300円（貸）保険料300円",
    difficulty: 1,
    tags_json:
  ...
  },
  {
    id: "Q_J_222",
    category_id: "journal",
    question_text: "支払家賃120,000円のうち、20,000円は次期分である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"前払費用","debit_amount":20000,"credit_account":"支払家賃","credit_amount":20000}}',
    explanation:
      "【基本概念】\n前払家賃は、事務所や店舗の賃料を前払いした場合の経過勘定処理です。賃貸借契約では通常、月初に当月分を支払いますが、決算時に次期分が含まれている場合は前払費用として資産計上します。\n\n【具体例・イメージ】\n事務所の年間家賃120,000円を一括前払いした場合、決算時点で残り期間分20,000円は次期の費用なので前払費用として処理します。マンションの家賃を数ヶ月分まとめて払った場合も同様です。\n\n【仕訳パターン】\n・決算時調整: （借）前払費用 ××× （貸）支払家賃 ×××\n・翌期首戻入: （借）支払家賃 ××× （貸）前払費用 ×××\n・期中支払時: （借）支払家賃 ××× （貸）現金預金 ×××\n・月次按分: 毎月一定額を費用計上\n\n【間違えやすいポイント】\n・前払家賃と敷金・保証金を混同する\n・当月分と次月分の期間区分を間違える\n・翌期首の戻入仕訳を忘れる\n・賃貸料と管理費・共益費を区別しない\n\n【覚え方のコツ】\n・「前払家賃」=「先払いした家賃」=「使用権」=資産\n・敷金は別勘定（差入保証金）で処理\n・家賃は期間按分、敷金は預託金として処理\n・決算整理で次期分を前払費用に振替\n\n【この問題の解き方】\n1. 支払家賃総額120,000円を確認\n2. 次期分20,000円を前払費用として資産計上\n3. 当期家賃費用は100,000円（120,000円-20,000円）\n4. 仕訳：（借）前払費用20,000円（貸）支払家賃20,000円",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"前払費用","accounts":["前払費用","支払家賃"],"keywords":["前払費用","支払家賃","期間配分","決算整理"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    id: "Q_J_223",
    category_id: "journal",
    question_text: "借入金利息90,000円のうち、15,000円は次期分である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"前払費用","debit_amount":15000,"credit_account":"支払利息","credit_amount":15000}}',
    explanation:
      "【基本概念】\n前払利息は、借入金に対する利息を前払いした場合の経過勘定処理です。利息は時間の経過とともに発生する費用なので、決算時に当期分と次期分を正確に区分する必要があります。\n\n【具体例・イメージ】\n銀行から借入を行い、年間利息90,000円を期首に一括前払いした場合、決算時点で残り期間（次期分）15,000円分はまだ経過していない前払分として資産計上します。\n\n【仕訳パターン】\n・決算時調整: （借）前払費用 ××× （貸）支払利息 ×××\n・翌期首戻入: （借）支払利息 ××× （貸）前払費用 ×××\n・期中支払時: （借）支払利息 ××× （貸）現金預金 ×××\n・月次按分: 毎月一定額を費用計上\n\n【間違えやすいポイント】\n・利息の期間按分計算を間違える\n・前払利息と未払利息を混同する\n・翌期首の戻入仕訳を忘れる\n・元本と利息を区別しない\n\n【覚え方のコツ】\n・「前払利息」=「先払いした利息」=「時間の権利」=資産\n・利息は時間に比例、期間按分が重要\n・決算整理で次期分を前払費用に振替\n・借入金（元本）とは別勘定で処理\n\n【この問題の解き方】\n1. 借入金利息総額90,000円を確認\n2. 次期分15,000円を前払費用として資産計上\n3. 当期利息費用は75,000円（90,000円-15,000円）\n4. 仕訳：（借）前払費用15,000円（貸）支払利息15,000円",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"前払費用","accounts":["前払費用","支払利息"],"keywords":["前払費用","支払利息","借入金利息","期間配分"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    id: "Q_J_224",
    category_id: "journal",
    question_text: "支払広告料60,000円のうち、10,000円は次期分である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"前払費用","debit_amount":10000,"credit_account":"広告宣伝費","credit_amount":10000}}',
    explanation:
      "【基本概念】\n前払広告費は、広告宣伝料を前払いした場合の経過勘定処理です。広告効果は時間の経過とともに発現するため、決算時に当期分と次期分を正確に区分する必要があります。\n\n【具体例・イメージ】\n年間60,000円の広告契約を結び期首に一括前払いした場合、決算時点で残り期間（次期分）10,000円分はまだ効果が発現していない前払分として資産計上します。雑誌広告や看板広告の年間契約も同様です。\n\n【仕訳パターン】\n・決算時調整: （借）前払費用 ××× （貸）広告宣伝費 ×××\n・翌期首戻入: （借）広告宣伝費 ××× （貸）前払費用 ×××\n・期中支払時: （借）広告宣伝費 ××× （貸）現金預金 ×××\n・効果按分: 広告効果の期間に応じて費用計上\n\n【間違えやすいポイント】\n・広告効果の期間按分計算を間違える\n・前払広告費と未払広告費を混同する\n・翌期首の戻入仕訳を忘れる\n・一時的な広告と継続的な広告を区別しない\n\n【覚え方のコツ】\n・「前払広告費」=「先払いした広告料」=「効果の権利」=資産\n・広告効果は期間に比例、期間按分が重要\n・決算整理で次期分を前払費用に振替\n・宣伝効果の期間対応を意識\n\n【この問題の解き方】\n1. 支払広告料総額60,000円を確認\n2. 次期分10,000円を前払費用として資産計上\n3. 当期広告宣伝費は50,000円（60,000円-10,000円）\n4. 仕訳：（借）前払費用10,000円（貸）広告宣伝費10,000円",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"前払費用","accounts":["前払費用","広告宣伝費"],"keywords":["前払費用","広告宣伝費","期間配分","決算整理"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    id: "Q_J_225",
    category_id: "journal",
    question_text: "受取家賃240,000円のうち、40,000円は次期分である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"受取家賃","debit_amount":40000,"credit_account":"前受収益","credit_amount":40000}}',
    explanation:
      "【基本概念】\n前受収益は、既に代金を受け取ったが、まだサービスを提供していない部分を負債として計上する経過勘定項目です。期間损益計算の適正化のため、当期分と次期分を正確に区分する必要があります。\n\n【具体例・イメージ】\nアパートの年間家賃240,000円を期首に一括受領した場合、決算時点で残り期間（次期分）40,000円分はまだサービス提供義務がある前受収益として負債計上します。\n\n【仕訳パターン】\n・決算時調整: （借）受取家賃 ××× （貸）前受収益 ×××\n・翌期首戻入: （借）前受収益 ××× （貸）受取家賃 ×××\n・期中受領時: （借）現金預金 ××× （貸）受取家賃 ×××\n・サービス提供: 時間経過とともに収益計上\n\n【間違えやすいポイント】\n・前受収益と前払費用を混同する\n・当期分と次期分の期間区分を間違える\n・翌期首の戻入仕訳を忘れる\n・収益と負債の関係を理解していない\n\n【覚え方のコツ】\n・「前受収益」=「先受けのお金」=「提供義務」=負債\n・受取家賃は時間に比例、期間按分が重要\n・決算整理で次期分を前受収益に振替\n・前受収益は負債の部に計上\n\n【この問題の解き方】\n1. 受取家賃総額240,000円を確認\n2. 次期分40,000円を前受収益として負債計上\n3. 当期家賃収益は200,000円（240,000円-40,000円）\n4. 仕訳：（借）受取家賃40,000円（貸）前受収益40,000円",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"前受収益","accounts":["受取家賃","前受収益"],"keywords":["前受収益","受取家賃","期間配分","決算整理"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    id: "Q_J_226",
    category_id: "journal",
    question_text: "受取利息360,000円のうち、60,000円は次期分である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"受取利息","debit_amount":60000,"credit_account":"前受収益","credit_amount":60000}}',
    explanation:
      "【基本概念】\n前受利息は、貸付金に対する利息を前受けした場合の経過勘定処理です。利息は時間の経過とともに発生する収益なので、決算時に当期分と次期分を正確に区分する必要があります。\n\n【具体例・イメージ】\n企業に年間360,000円の貸付を行い、利息を期首に一括受領した場合、決算時点で残り期間（次期分）60,000円分はまだ時間が経過していない前受収益として負債計上します。\n\n【仕訳パターン】\n・決算時調整: （借）受取利息 ××× （貸）前受収益 ×××\n・翌期首戻入: （借）前受収益 ××× （貸）受取利息 ×××\n・期中受取時: （借）現金預金 ××× （貸）受取利息 ×××\n・時間経過: 毎月一定額を収益計上\n\n【間違えやすいポイント】\n・前受利息と前払利息を混同する\n・利息の期間按分計算を間違える\n・翌期首の戻入仕訳を忘れる\n・元本と利息を区別しない\n\n【覚え方のコツ】\n・「前受利息」=「先受けの利息」=「時間の義務」=負債\n・利息は時間に比例、期間按分が重要\n・決算整理で次期分を前受収益に振替\n・貸付金（元本）とは別勘定で処理\n\n【この問題の解き方】\n1. 受取利息総額360,000円を確認\n2. 次期分60,000円を前受収益として負債計上\n3. 当期利息収益は300,000円（360,000円-60,000円）\n4. 仕訳：（借）受取利息60,000円（貸）前受収益60,000円",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"前受収益","accounts":["受取利息","前受収益"],"keywords":["前受収益","受取利息","貸付金利息","期間配分"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    id: "Q_J_227",
    category_id: "journal",
    question_text: "受取手数料180,000円のうち、30,000円は次期分である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"受取手数料","debit_amount":30000,"credit_account":"前受収益","credit_amount":30000}}',
    explanation:
      "【基本概念】\n前受手数料は、手数料を前受けした場合の経過勘定処理です。手数料収益はサービスの提供とともに発生する収益なので、決算時に当期分と次期分を正確に区分する必要があります。\n\n【具体例・イメージ】\n不動産仲介会社が年間管理手数料180,000円を期首に一括受領した場合、決算時点で残り期間（次期分）30,000円分はまだサービス提供義務がある前受収益として負債計上します。\n\n【仕訳パターン】\n・決算時調整: （借）受取手数料 ××× （貸）前受収益 ×××\n・翌期首戻入: （借）前受収益 ××× （貸）受取手数料 ×××\n・期中受領時: （借）現金預金 ××× （貸）受取手数料 ×××\n・サービス提供: サービス実行とともに収益計上\n\n【間違えやすいポイント】\n・前受手数料と未収手数料を混同する\n・サービス提供期間の按分計算を間違える\n・翌期首の戻入仕訳を忘れる\n・収益と負債の関係を理解していない\n\n【覚え方のコツ】\n・「前受手数料」=「先受けの手数料」=「サービス義務」=負債\n・手数料はサービス提供に比例、期間按分が重要\n・決算整理で次期分を前受収益に振替\n・前受収益は負債の部に計上\n\n【この問題の解き方】\n1. 受取手数料総額180,000円を確認\n2. 次期分30,000円を前受収益として負債計上\n3. 当期手数料収益は150,000円（180,000円-30,000円）\n4. 仕訳：（借）受取手数料30,000円（貸）前受収益30,000円",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"前受収益","accounts":["受取手数料","前受収益"],"keywords":["前受収益","受取手数料","サービス提供","期間配分"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-19T06:38:39.254Z",
  },
  {
    id: "Q_J_228",
    category_id: "journal",
    question_text: "当期の給料150,000円が未払いである。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"給料","debit_amount":150000,"credit_account":"未払費用","credit_amount":150000}}',
    explanation:
      "【基本概念】\n未払給料は、従業員の労働に対する給料が発生しているが、まだ支払っていない状態を表す経過勘定項目です。発生主義の原則に従い、支払いの有無に関わらず当期の費用として計上します。\n\n【具体例・イメージ】\n3月決算の会社で、4月支給予定の3月分給料150,000円がまだ支払われていない場合、この金額を当期の給料費用として計上し、同時に未払費用として負債計上します。\n\n【仕訳パターン】\n・未払計上: （借）給料 ××× （貸）未払費用 ×××\n・実際支払時: （借）未払費用 ××× （貸）現金預金 ×××\n・翌期首処理: 洗替法の場合は戻入仕訳\n・社会保険料: 会社負担分も未払費用計上\n\n【間違えやすいポイント】\n・支払時の未払費用取崩しを忘れる\n・発生主義と現金主義を混同する\n・社会保険料の会社負担分を忘れる\n・給料と賞与を区別しない\n\n【覚え方のコツ】\n・「未払給料」=「働いた分は費用」=「支払義務」=負債\n・発生主義＝支払いの有無に関わらず費用計上\n・計上時は費用計上、支払時は未払費用取崩\n・給料は毎月発生、月末未払分を計上\n\n【この問題の解き方】\n1. 当期の給料発生額150,000円を確認\n2. まだ支払いが完了していない状態\n3. 発生主義により当期費用として計上\n4. 仕訳：（借）給料150,000円（貸）未払費用150,000円",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"未払費用","accounts":["給料","未払費用"],"keywords":["未払費用","給料","発生主義","決算整理"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    id: "Q_J_229",
    category_id: "journal",
    question_text: "当期の借入金利息80,000円が未払いである。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"支払利息","debit_amount":80000,"credit_account":"未払費用","credit_amount":80000}}',
    explanation:
      "【基本概念】\n未払利息は、借入金に対する利息が発生しているが、まだ支払っていない状態を表す経過勘定項目です。利息は時間の経過とともに発生する費用なので、発生主義の原則に従い、支払いの有無に関わらず当期の費用として計上する必要があります。\n\n【具体例・イメージ】\n銀行から年利3%で借入を行い、3月決算時点で4月支払予定の利息80,000円がまだ支払われていない場合、この金額を当期の支払利息費用として計上し、同時に未払費用として負債計上します。\n\n【仕訳パターン】\n・未払計上: （借）支払利息 ××× （貸）未払費用 ×××\n・実際支払時: （借）未払費用 ××× （貸）現金預金 ×××\n・翌期首処理: 洗替法の場合は戻入仕訳\n・月次按分: 毎月一定額を費用計上\n\n【間違えやすいポイント】\n・利息の期間按分計算を間違える\n・支払時の未払費用取崩しを忘れる\n・元本と利息を区別しない\n・発生主義と現金主義を混同する\n\n【覚え方のコツ】\n・「未払利息」=「時間で発生」=「支払義務」=負債\n・利息は時間に比例、期間按分が重要\n・計上時は費用計上、支払時は未払費用取崩\n・借入金（元本）とは別勘定で処理\n\n【この問題の解き方】\n1. 当期の借入金利息発生額80,000円を確認\n2. まだ支払いが完了していない状態\n3. 発生主義により当期費用として計上\n4. 仕訳：（借）支払利息80,000円（貸）未払費用80,000円",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"未払費用","accounts":["支払利息","未払費用"],"keywords":["未払費用","支払利息","借入金利息","期間対応"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    id: "Q_J_230",
    category_id: "journal",
    question_text: "当期の賃借料90,000円が未払いである。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"賃借料","debit_amount":90000,"credit_account":"未払費用","credit_amount":90000}}',
    explanation:
      "【基本概念】\n未払家賃は、賃借している建物（店舗・事務所・倉庫等）の使用料（家賃）が発生しているものの、まだ支払いが完了していない状態を表します。発生主義に基づき、費用として計上すると同時に支払義務（負債）も認識する必要があります。\n\n【具体例・イメージ】\n月末締めの家賃支払いで、3月分の家賃10万円を4月に支払う場合、3月31日時点では「使用した分の費用は発生済み、支払いは翌月」という状況です。まだ口座から引き落とされていなくても、家賃という費用は発生しており、支払う義務も確定しています。\n\n【仕訳パターン】\n・期末時（家賃発生、未払計上）: 借方「賃借料」、貸方「未払費用」\n・翌期支払時: 借方「未払費用」、貸方「現金・普通預金」\n・継続使用の場合: 借方「賃借料」、貸方「現金・普通預金」（新たな費用分）\n\n【間違えやすいポイント】\n・未払費用（負債）と前払費用（資産）を混同\n・賃借料（費用）と未払費用（負債）の区別不明確\n・支払時に賃借料を再度計上してしまう二重計上ミス\n・翌期の振戻処理を忘れるケース\n\n【覚え方のコツ】\n・「未払」= まだ払っていない = 支払義務 = 負債\n・「賃借料」= 場所を借りる費用 = 費用勘定\n・発生主義：「使ったら費用、支払義務も同時発生」\n・現金の動きと費用発生のタイミングは別\n\n【この問題の仕訳】\n借方：賃借料 90,000円（費用の発生）\n貸方：未払費用 90,000円（支払義務の認識）\n\n建物使用により賃借料という費用が90,000円発生し、同時にその金額を支払う義務（未払費用）も90,000円発生したことを表しています。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"未払費用","accounts":["賃借料","未払費用"],"keywords":["未払費用","賃借料","家賃","期間対応","発生主義"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    id: "Q_J_231",
    category_id: "journal",
    question_text: "当期の賃貸料75,000円が未収である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"未収収益","debit_amount":75000,"credit_account":"賃貸料","credit_amount":75000}}',
    explanation:
      "【基本概念】\n未収家賃（未収賃貸料）は、貸主として建物や土地を他人に賃貸している場合で、賃貸料収入が発生しているものの、まだ賃借人から代金を受け取っていない状態を表します。発生主義に基づき、収益として計上すると同時に代金を受け取る権利（資産）も認識する必要があります。\n\n【具体例・イメージ】\n所有しているマンションの一室を月10万円で賃貸している場合、3月分の家賃10万円を4月に受け取る契約だとすると、3月31日時点では「貸した分の収益は発生済み、代金受取は翌月」という状況です。まだ入金されていなくても、賃貸料という収益は発生しており、代金を受け取る権利も確定しています。\n\n【仕訳パターン】\n・期末時（賃貸料発生、未収計上）: 借方「未収収益」、貸方「賃貸料」\n・翌期受取時: 借方「現金・普通預金」、貸方「未収収益」\n・継続賃貸の場合: 借方「現金・普通預金」、貸方「賃貸料」（新たな収益分）\n\n【間違えやすいポイント】\n・未収収益（資産）と前受収益（負債）を混同\n・賃貸料（収益）と未収収益（資産）の区別不明確\n・受取時に賃貸料を再度計上してしまう二重計上ミス\n・翌期の振戻処理を忘れるケース\n\n【覚え方のコツ】\n・「未収」= まだ受け取っていない = 受取権利 = 資産\n・「賃貸料」= 場所を貸す収益 = 収益勘定\n・発生主義：「貸したら収益、受取権利も同時発生」\n・現金の動きと収益発生のタイミングは別\n\n【この問題の仕訳】\n借方：未収収益 75,000円（代金受取権利の認識）\n貸方：賃貸料 75,000円（収益の発生）\n\n建物賃貸により賃貸料という収益が75,000円発生し、同時にその金額を受け取る権利（未収収益）も75,000円発生したことを表しています。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"未収収益","accounts":["未収収益","賃貸料"],"keywords":["未収収益","賃貸料","家賃","期間対応","発生主義"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-19T06:38:39.257Z",
  },
  {
    id: "Q_J_232",
    category_id: "journal",
    question_text: "当期の受取利息12,000円が未収である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"未収収益","debit_amount":12000,"credit_account":"受取利息","credit_amount":12000}}',
    explanation:
      "【基本概念】\n未収利息は、貸付金や預金などから発生する利息収入が当期分として発生しているものの、まだ受け取っていない状態を表します。発生主義に基づき、収益として計上すると同時に代金を受け取る権利（資産）も認識する必要があります。\n\n【具体例・イメージ】\n銀行の定期預金で年利2%の場合、毎月利息が発生していますが、実際の受取は満期時や決められた支払日になります。3月分の利息が発生しているが4月に受け取る場合、3月31日時点では「利息は発生済み、受取は翌月」という状況です。\n\n【仕訳パターン】\n・期末時（利息発生、未収計上）: 借方「未収収益」、貸方「受取利息」\n・翌期受取時: 借方「現金・普通預金」、貸方「未収収益」\n・継続契約の場合: 借方「現金・普通預金」、貸方「受取利息」（新たな収益分）\n\n【間違えやすいポイント】\n・未収収益（資産）と前受収益（負債）を混同\n・受取利息（収益）と未収収益（資産）の区別不明確\n・受取時に受取利息を再度計上してしまう二重計上ミス\n・翌期の振戻処理を忘れるケース\n・支払利息との混同（借方貸方が逆になる）\n\n【覚え方のコツ】\n・「未収」= まだ受け取っていない = 受取権利 = 資産\n・「受取利息」= お金を貸した対価 = 収益勘定\n・発生主義：「貸したら利息発生、受取権利も同時発生」\n・現金の動きと収益発生のタイミングは別\n・「受取」は収益、「支払」は費用\n\n【この問題の仕訳】\n借方：未収収益 12,000円（利息受取権利の認識）\n貸方：受取利息 12,000円（利息収益の発生）\n\n貸付金等により受取利息という収益が12,000円発生し、同時にその金額を受け取る権利（未収収益）も12,000円発生したことを表しています。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"未収収益","accounts":["未収収益","受取利息"],"keywords":["未収収益","受取利息","貸付金利息","期間対応","発生主義"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    id: "Q_J_233",
    category_id: "journal",
    question_text: "当期の手数料収入25,000円が未収である。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"未収収益","debit_amount":25000,"credit_account":"受取手数料","credit_amount":25000}}',
    explanation:
      "【基本概念】\n未収手数料は、企業が提供したサービスや仲介業務に対する手数料収入が発生しているものの、まだ顧客から代金を受け取っていない状態を表します。発生主義に基づき、収益として計上すると同時に代金を受け取る権利（資産）も認識する必要があります。\n\n【具体例・イメージ】\n不動産仲介業で3月に契約成立した物件の仲介手数料50万円を4月に受け取る場合、3月31日時点では「サービスは提供済み、代金受取は翌月」という状況です。まだ入金されていなくても、手数料という収益は発生しており、代金を受け取る権利も確定しています。\n\n【仕訳パターン】\n・期末時（手数料発生、未収計上）: 借方「未収収益」、貸方「受取手数料」\n・翌期受取時: 借方「現金・普通預金」、貸方「未収収益」\n・継続サービスの場合: 借方「現金・普通預金」、貸方「受取手数料」（新たな収益分）\n\n【間違えやすいポイント】\n・未収収益（資産）と前受収益（負債）を混同\n・受取手数料（収益）と未収収益（資産）の区別不明確\n・受取時に受取手数料を再度計上してしまう二重計上ミス\n・翌期の振戻処理を忘れるケース\n・支払手数料との混同（借方貸方が逆になる）\n\n【覚え方のコツ】\n・「未収」= まだ受け取っていない = 受取権利 = 資産\n・「受取手数料」= サービス提供の対価 = 収益勘定\n・発生主義：「サービス提供したら収益、受取権利も同時発生」\n・現金の動きと収益発生のタイミングは別\n・「受取」は収益、「支払」は費用\n\n【この問題の仕訳】\n借方：未収収益 25,000円（手数料受取権利の認識）\n貸方：受取手数料 25,000円（手数料収益の発生）\n\nサービス提供により受取手数料という収益が25,000円発生し、同時にその金額を受け取る権利（未収収益）も25,000円発生したことを表しています。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"未収収益","accounts":["未収収益","受取手数料"],"keywords":["未収収益","受取手数料","手数料収入","期間対応","発生主義"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    id: "Q_J_234",
    category_id: "journal",
    question_text: "前期末に計上した前払費用30,000円を翌期首に振り戻す。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"保険料","debit_amount":30000,"credit_account":"前払費用","credit_amount":30000}}',
    explanation:
      "【基本概念】\n経過勘定の翌期首振戻処理は、前期末に計上した経過勘定項目（前払費用・前受収益・未払費用・未収収益）を翌期首に逆仕訳で振り戻す処理です。これにより、翌期の会計処理を単純化し、実際の現金収支と期間損益計算を正確に行うことができます。\n\n【具体例・イメージ】\n前期末に1年分の保険料12万円を支払い、うち3万円を前払費用として資産計上した場合、翌期首にその3万円を費用に振り戻すことで、翌期の保険料処理が現金主義的に行えます。\n\n【仕訳パターン】\n・前払費用の振戻: 借方「費用勘定」、貸方「前払費用」\n・前受収益の振戻: 借方「前受収益」、貸方「収益勘定」\n・未払費用の振戻: 借方「未払費用」、貸方「費用勘定」\n・未収収益の振戻: 借方「収益勘定」、貸方「未収収益」\n\n【間違えやすいポイント】\n・振戻仕訳の借方貸方を逆にしてしまう\n・振戻処理を忘れて二重計上になる\n・振戻金額を間違える（前期末計上額と同額でなければならない）\n・決算時の仕訳と振戻時の仕訳を混同する\n\n【覚え方のコツ】\n・「振戻」= 前期末の逆仕訳を翌期首に行う\n・前払費用の振戻: 前払費用（資産）を減らして費用を増やす\n・経過勘定は「期末に計上、期首に振戻」がセット\n・振戻により実際の収支ベースで翌期の処理が可能\n\n【この問題の仕訳】\n借方：保険料 30,000円（費用の復活）\n貸方：前払費用 30,000円（資産の取崩）\n\n前期末に計上した前払費用30,000円を翌期首に振り戻すことで、翌期の保険料処理を実際の支払いベースで行えるようになります。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"経過勘定振戻","accounts":["保険料","前払費用"],"keywords":["経過勘定","振戻処理","翌期首","前払費用"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "決算において、前払保険料15,000円と未収賃貸料8,000円を計上する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"前払費用","debit_amount":15000,"credit_account":"保険料","credit_amount":15000}}',
    explanation:
      "【基本概念】\n複合的経過勘定処理は、決算時に複数の経過勘定項目を同時に処理する場合の問題です。前払費用・前受収益・未払費用・未収収益の各パターンを正確に理解し、それぞれの性質に応じた適切な仕訳を行う必要があります。\n\n【具体例・イメージ】\n年度末決算で、保険料の前払分15,000円と賃貸料の未収分8,000円が発生している状況です。それぞれ異なる経過勘定の性質を持ちますが、どちらも期間損益計算の適正化のための調整です。\n\n【仕訳パターン】\n・前払費用: 借方「前払費用」、貸方「費用勘定」\n・前受収益: 借方「収益勘定」、貸方「前受収益」\n・未払費用: 借方「費用勘定」、貸方「未払費用」\n・未収収益: 借方「未収収益」、貸方「収益勘定」\n\n【間違えやすいポイント】\n・複数項目を1つの仕訳でまとめようとする（個別に処理すべき）\n・前払・前受・未払・未収の借方貸方を混同する\n・資産・負債・収益・費用の性質を間違える\n・金額の計算ミスや勘定科目の選択ミス\n\n【覚え方のコツ】\n・「前払」= 先に払った = 資産（左側）\n・「前受」= 先に受けた = 負債（右側）\n・「未払」= まだ払っていない = 負債（右側）\n・「未収」= まだ受けていない = 資産（左側）\n・複合問題でも基本パターンの組み合わせ\n\n【この問題の仕訳】\n1. 前払保険料の処理:\n借方：前払費用 15,000円\n貸方：保険料 15,000円\n\n2. 未収賃貸料の処理:\n借方：未収収益 8,000円\n貸方：賃貸料 8,000円\n\n※CBT形式では通常1つの仕訳のみ入力するため、問題で指定された方を解答してください。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"複合経過勘定","accounts":["前払費用","保険料","未収収益","賃貸料"],"keywords":["経過勘定","複合処理","前払費用","未収収益"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "期首に消耗品費として計上した80,000円のうち、期末に未使用分として12,000円が残っている。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"消耗品","debit_amount":12000,"credit_account":"消耗品費","credit_amount":12000}}',
    explanation:
      "【基本概念】\n消耗品の期末棚卸は、購入時に費用計上した消耗品のうち、期末に未使用で残っているものを資産として計上し直す決算整理処理です。これにより当期の消耗品費を正しい金額（実際に使用した分のみ）に修正できます。\n\n【具体例・イメージ】\n事務用品（ペン、紙、封筒など）を年度初めに大量購入し、いったん消耗品費として処理しました。しかし決算時に倉庫を確認すると、まだ使っていない事務用品が残っていました。この未使用分は来期以降使う予定なので、資産として計上し直す必要があります。\n\n【仕訳パターン】\n・購入時: 借方に消耗品費、貸方に現金\n・期末整理: 借方に消耗品（資産）、貸方に消耗品費\n・翌期首: 借方に消耗品費、貸方に消耗品（再振替）\n\n【間違えやすいポイント】\n・消耗品（資産）と消耗品費（費用）の区別を間違える\n・期末に未使用分を費用から資産に振り替える処理を忘れる\n・翌期首の再振替処理を忘れがち\n・金額を間違える（未使用分ではなく使用分で仕訳してしまう）\n\n【覚え方のコツ】\n・期末に「残っているもの」は資産\n・費用から資産への振替 = 借方消耗品、貸方消耗品費\n・使用分 = 購入額 - 未使用分\n・翌期首は逆仕訳で戻す\n\n【この問題の解き方】\n期末未使用分12,000円を消耗品費（費用）から消耗品（資産）に振り替えます。これにより当期の消耗品費は68,000円（80,000円 - 12,000円）となり、実際の使用額が正しく反映されます。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"消耗品棚卸","accounts":["消耗品","消耗品費"],"keywords":["消耗品","期末棚卸","決算整理","資産計上"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
  ...
  },
  {
    ...
    category_id: "journal",
    question_text:
      "期首に貯蔵品として計上した原材料150,000円のうち、期末実地棚卸により120,000円が確認された。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"材料費","debit_amount":30000,"credit_account":"貯蔵品","credit_amount":30000}}',
    explanation:
      "【基本概念】\n貯蔵品の期末棚卸は、期首残高と期末実際残高を比較し、使用された分を適切な費用勘定に振り替える決算整理処理です。実地棚卸によって正確な在庫量を把握し、期中に使用された分を費用として計上します。\n\n【具体例・イメージ】\n製造業で原材料を倉庫に保管している場面をイメージしてください。年度初めに150万円分の原材料があり、期末に実際に倉庫を確認したら120万円分しか残っていませんでした。差額の30万円は製造に使用されたため、材料費として計上する必要があります。\n\n【仕訳パターン】\n・期首: 借方に貯蔵品、貸方に繰越（前期末処理の逆仕訳）\n・期中使用時: 借方に材料費等、貸方に貯蔵品\n・期末整理: 借方に材料費、貸方に貯蔵品（使用分を費用化）\n・期末: 借方に繰越、貸方に貯蔵品（次期への繰越）\n\n【間違えやすいポイント】\n・貯蔵品（資産）と材料費（費用）の区別を間違える\n・期首残高と期末残高の差額計算を間違える\n・使用分ではなく残高分で仕訳してしまう\n・実地棚卸の重要性を理解していない\n\n【覚え方のコツ】\n・貯蔵品は「保管中の材料」（資産）\n・材料費は「使用した材料」（費用）\n・使用分 = 期首残高 - 期末実際残高\n・「減った分」が費用になる\n\n【この問題の解き方】\n期首貯蔵品150,000円から期末実際残高120,000円を差し引いた30,000円が使用分です。この使用分を貯蔵品（資産）から材料費（費用）に振り替えます。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"貯蔵品棚卸","accounts":["材料費","貯蔵品"],"keywords":["貯蔵品","実地棚卸","在庫評価","材料費"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "期首仕掛品200,000円、当期製造費用800,000円、期末仕掛品180,000円である。製品の製造原価を算定せよ。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"製品","debit_amount":820000,"credit_account":"仕掛品","credit_amount":820000}}',
    explanation:
      "【基本概念】\n仕掛品の期末棚卸は製造業特有の決算整理で、製造原価の正確な算定に不可欠です。期首仕掛品と当期製造費用の合計から期末仕掛品を差し引いて、完成した製品の製造原価を求めます。\n\n【具体例・イメージ】\n工場で製品を作っている場面をイメージしてください。年度初めに未完成の製品（仕掛品）が20万円分あり、1年間で製造費用80万円をかけて製品を作りました。年度末に18万円分の仕掛品が残ったので、完成した製品の製造原価は82万円（20万円 + 80万円 - 18万円）となります。\n\n【仕訳パターン】\n・製造費用発生時: 借方に仕掛品、貸方に材料費/労務費/経費\n・製品完成時: 借方に製品、貸方に仕掛品（製造原価分）\n・製品売上時: 借方に売上原価、貸方に製品\n\n【計算式】\n製造原価 = 期首仕掛品 + 当期製造費用 - 期末仕掛品\n本問の場合: 200,000円 + 800,000円 - 180,000円 = 820,000円\n\n【間違えやすいポイント】\n・仕掛品（未完成品）と製品（完成品）の区別を間違える\n・製造原価の計算式を間違える\n・期末仕掛品を加算してしまう（正しくは減算）\n・製造費用と販売費を混同してしまう\n\n【覚え方のコツ】\n・仕掛品は「作りかけの製品」\n・製造原価 = 投入総額 - 未完成分\n・「始まり + 投入 - 残り = 完成」\n・完成品は仕掛品から製品勘定へ振替\n\n【この問題の解き方】\n期首仕掛品200,000円と当期製造費用800,000円の合計1,000,000円から、期末仕掛品180,000円を差し引いた820,000円が完成した製品の製造原価です。この金額を仕掛品から製品に振り替えます。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"仕掛品棚卸","accounts":["製品","仕掛品"],"keywords":["仕掛品","製造原価","製品完成","棚卸"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "期末商品棚卸において、帳簿棚卸高350,000円に対し、実地棚卸高が320,000円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"棚卸減耗損","debit_amount":30000,"credit_account":"繰越商品","credit_amount":30000}}',
    explanation:
      "【基本概念】\n期末商品棚卸の実地棚卸反映は、帳簿上の商品残高と実際の商品残高の差額を適切に処理する決算整理です。実地棚卸によって判明した商品の減耗や紛失を棚卸減耗損として計上し、正確な期末商品残高を反映します。\n\n【具体例・イメージ】\n小売店の決算時をイメージしてください。帳簿では35万円の商品があるはずなのに、実際に店舗や倉庫で商品を数えたら32万円しかありませんでした。差額の3万円は盗難、破損、計算ミス等で失われた商品なので、棚卸減耗損として費用計上する必要があります。\n\n【仕訳パターン】\n・帳簿棚卸高 > 実地棚卸高の場合:\n  借方に棚卸減耗損、貸方に繰越商品（減耗分）\n・帳簿棚卸高 < 実地棚卸高の場合:\n  借方に繰越商品、貸方に棚卸減耗戻入（増加分）\n\n【計算式】\n棚卸減耗損 = 帳簿棚卸高 - 実地棚卸高\n本問の場合: 350,000円 - 320,000円 = 30,000円\n\n【間違えやすいポイント】\n・帳簿棚卸高と実地棚卸高の大小関係を間違える\n・差額の計算を間違える（逆算してしまう）\n・棚卸減耗損ではなく他の勘定を使ってしまう\n・実地棚卸の重要性を理解していない\n\n【覚え方のコツ】\n・実地棚卸が「正しい」残高\n・帳簿より実際が少ない = 減耗損（費用）\n・帳簿より実際が多い = 減耗戻入（収益）\n・「足りない分」は損失として処理\n\n【この問題の解き方】\n帳簿棚卸高350,000円から実地棚卸高320,000円を差し引いた30,000円が棚卸減耗損です。この金額を繰越商品（資産）から棚卸減耗損（費用）に振り替えます。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"商品棚卸","accounts":["棚卸減耗損","繰越商品"],"keywords":["期末商品棚卸","実地棚卸","棚卸減耗損","商品減耗"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "期末商品のうち、取得原価100,000円の商品について、市場価格が70,000円に下落している。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"商品評価損","debit_amount":30000,"credit_account":"繰越商品","credit_amount":30000}}',
    explanation:
      "【基本概念】\n棚卸資産の評価損は、期末において商品の時価が取得原価を下回った場合に、その価値の下落分を損失として計上する決算整理処理です。低価法の適用により、商品の実質的な価値減少を適切に反映します。\n\n【具体例・イメージ】\n電子機器を販売する会社をイメージしてください。10万円で仕入れたスマートフォンが、新機種の発売により市場価格が7万円に下落しました。このままでは売っても損失が出るので、価値の下落分3万円を商品評価損として計上し、商品の帳簿価額を実際の価値に合わせます。\n\n【仕訳パターン】\n・商品評価損計上時: 借方に商品評価損、貸方に繰越商品\n・翌期の回復時: 借方に繰越商品、貸方に商品評価損戻入\n・実際売却時: 借方に現金等、貸方に売上（時価ベース）\n\n【計算式】\n商品評価損 = 取得原価 - 期末時価\n本問の場合: 100,000円 - 70,000円 = 30,000円\n\n【間違えやすいポイント】\n・取得原価と時価のどちらが大きいかを間違える\n・商品評価損ではなく他の損失勘定を使ってしまう\n・低価法の適用条件を理解していない\n・翌期の戻入処理を忘れる\n\n【覚え方のコツ】\n・低価法 = 「安い方を選ぶ」方法\n・取得原価 > 時価 → 評価損計上\n・取得原価 < 時価 → 評価益は計上しない\n・「価値が下がった分」は損失\n\n【関連する会計原則】\n・保守主義の原則: 損失は早めに、利益は確実になってから\n・費用収益対応の原則: 期間損益の適正化\n・低価法: 取得原価と時価の低い方で評価\n\n【この問題の解き方】\n取得原価100,000円から期末時価70,000円を差し引いた30,000円が商品評価損です。この金額を繰越商品（資産）から商品評価損（費用）に振り替えて、商品の帳簿価額を実際の価値に調整します。",
    difficulty: 2,
    tags_json:
      '{"subcategory":"adjustment","pattern":"商品評価損","accounts":["商品評価損","繰越商品"],"keywords":["商品評価損","低価法","時価評価","陳腐化"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "決算において、現金過不足勘定に貸方残高8,000円がある。原因が不明なため決算整理する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"現金過不足","debit_amount":8000,"credit_account":"雑益","credit_amount":8000}}',
    explanation:
      "【基本概念】\n現金過不足の決算整理は、期中に発生した現金の帳簿残高と実際残高の差額について、原因が判明しない場合に雑損益として処理する決算整理です。貸方残高は実際現金が帳簿より多い状態で、雑益として計上します。\n\n【具体例・イメージ】\n小売店のレジ締めをイメージしてください。1年間の取引で、帳簿上の現金より実際の現金が8,000円多くありました。お釣りの計算間違い、売上の記録漏れなどが考えられますが、詳細な原因は分からないため、「思いがけない利益」として雑益に計上します。\n\n【仕訳パターン】\n・現金過不足が貸方残高（現金が多い）:\n  借方に現金過不足、貸方に雑益\n・現金過不足が借方残高（現金が不足）:\n  借方に雑損、貸方に現金過不足\n・原因判明時: 適切な勘定科目に振り替え\n\n【現金過不足勘定の性質】\n・期中の一時的な勘定（決算で必ず0にする）\n・借方残高 = 現金不足 → 雑損へ振替\n・貸方残高 = 現金過剰 → 雑益へ振替\n・原因判明分は該当科目へ直接振替\n\n【間違えやすいポイント】\n・借方残高と貸方残高で振替先を間違える\n・雑損・雑益ではなく他の勘定を使ってしまう\n・現金過不足勘定を残したまま決算してしまう\n・原因判明分と未判明分の処理を混同する\n\n【覚え方のコツ】\n・貸方残高 = 現金が「余っている」→ 雑益（プラス）\n・借方残高 = 現金が「足りない」→ 雑損（マイナス）\n・決算では現金過不足勘定は必ず0残高にする\n・「過不足」は一時的、「雑損益」は最終的\n\n【この問題の解き方】\n現金過不足勘定の貸方残高8,000円は、実際現金が帳簿より多い状態を示しています。原因不明のため、この金額を雑益（収益）として計上し、現金過不足勘定を0にします。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"現金過不足","accounts":["現金過不足","雑益"],"keywords":["現金過不足","決算整理","雑益","原因不明"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    id: "Q_J_242",
    category_id: "journal",
    question_text: "当期純利益500,000円を繰越利益剰余金に振り替える。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"当期純利益","debit_amount":500000,"credit_account":"繰越利益剰余金","credit_amount":500000}}',
    explanation:
      "【基本概念】\n当期純利益の繰越利益剰余金振替は、決算確定後に行う重要な処理です。損益計算書で算定された当期純利益を、貸借対照表の純資産の部にある繰越利益剰余金に移し替えることで、利益の蓄積を表現します。\n\n【具体例・イメージ】\n会社の1年間の成果をイメージしてください。営業活動で得た純利益50万円を、会社の内部留保として蓄積します。この利益は将来の投資や配当の原資となる重要な資金です。\n\n【仕訳パターン】\n・当期純利益発生時: 借方に当期純利益、貸方に繰越利益剰余金\n・当期純損失発生時: 借方に繰越利益剰余金、貸方に当期純損失\n・利益処分時: 配当金支払いや任意積立金設定\n\n【会計的意義】\n・損益計算書と貸借対照表の連結点\n・株主資本の増加要因\n・将来の配当可能利益の源泉\n・企業の成長力を示す指標\n\n【間違えやすいポイント】\n・当期純利益と当期純損失で仕訳が逆になる\n・繰越利益剰余金ではなく他の剰余金勘定を使ってしまう\n・利益処分と混同してしまう\n・借方貸方を間違える\n\n【覚え方のコツ】\n・純利益は「稼いだお金」→ 資本の増加\n・繰越利益剰余金は「貯金箱」\n・利益 → 貯金箱への移動\n・借方当期純利益、貸方繰越利益剰余金\n\n【関連処理】\n・配当金の支払い\n・任意積立金の設定\n・前期繰越損失の補填\n・税効果会計の適用\n\n【この問題の解き方】\n当期純利益500,000円を繰越利益剰余金に振り替えます。これにより損益計算書の純利益が貸借対照表の純資産に移され、会計期間の区切りが明確になります。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"純利益振替","accounts":["当期純利益","繰越利益剰余金"],"keywords":["当期純利益","繰越利益剰余金","利益処分","決算"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "株主への配当金として引出金150,000円を資本金から振り替える。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"資本金","debit_amount":150000,"credit_account":"引出金","credit_amount":150000}}',
    explanation:
      "【基本概念】\n引出金の資本金振替処理は、個人事業主が事業用資金を個人用途に使用した場合の決算整理です。引出金勘定に計上されていた金額を、最終的に資本金（または資本勘定）から差し引くことで、正確な期末資本金額を算定します。\n\n【具体例・イメージ】\n個人事業主をイメージしてください。1年間の事業で15万円を生活費として引き出しました。これは事業の利益から支払われるのではなく、事業主の出資元本（資本金）を減らす取引なので、期末に資本金から差し引く必要があります。\n\n【仕訳パターン】\n・引出時: 借方に引出金、貸方に現金\n・期末振替: 借方に資本金、貸方に引出金\n・法人の場合: 借方に役員賞与、貸方に引出金（または直接現金）\n\n【個人事業と法人の違い】\n・個人事業: 引出金 → 資本金から控除\n・法人: 役員賞与 → 費用として処理（ただし損金不算入）\n・引出金は個人事業主特有の勘定科目\n・法人では株主への配当金として処理\n\n【間違えやすいポイント】\n・引出金を費用と考えてしまう（正しくは資本の減少）\n・期末振替を忘れて引出金勘定を残してしまう\n・法人と個人事業の処理を混同する\n・借方貸方を間違える\n\n【覚え方のコツ】\n・引出金は「資本の引き出し」\n・費用ではなく資本の減少\n・期末には必ず資本金へ振替\n・借方資本金、貸方引出金で消去\n\n【関連する論点】\n・個人事業主の所得税計算\n・青色申告特別控除\n・事業主借・事業主貸との関係\n・資本金の増減記録\n\n【この問題の解き方】\n引出金150,000円を資本金から差し引いて振り替えます。これにより引出金勘定は0になり、資本金は引出分だけ減少して正確な期末残高が算定されます。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"引出金振替","accounts":["資本金","引出金"],"keywords":["引出金","資本金","個人事業主","資本減少"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "仮払金50,000円の内容が判明し、旅費交通費30,000円、会議費20,000円であった。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"旅費交通費","debit_amount":30000,"credit_account":"仮払金","credit_amount":30000}}',
    explanation:
      "【基本概念】\n仮払金・仮受金の本科目振替は、一時的に計上していた仮勘定の内容が判明した際に、適切な本来の勘定科目に振り替える決算整理処理です。複数の費用項目が含まれる場合は、それぞれを個別に処理します。\n\n【具体例・イメージ】\n社員の出張をイメージしてください。出張前に概算で5万円を仮払いしました。出張後の精算で、電車代3万円と会議費2万円の領収書が提出されました。この時点で仮払金の内容が明確になるので、適切な費用科目に振り替えます。\n\n【仕訳パターン】\n・仮払時: 借方に仮払金、貸方に現金\n・内容判明時: 借方に適切な費用科目、貸方に仮払金\n・過不足がある場合: 不足分は追加支払い、余剰分は返金\n・仮受金の場合: 借方に仮受金、貸方に適切な収益科目\n\n【複合仕訳の処理】\n本問では2つの費用項目があるため、以下の処理が必要：\n1. 旅費交通費30,000円 / 仮払金30,000円\n2. 会議費20,000円 / 仮払金20,000円\n※問題では1つの仕訳で回答するため、主要項目で代表\n\n【間違えやすいポイント】\n・仮払金を費用のまま残してしまう\n・複数項目を一つの科目にまとめてしまう\n・仮払金と仮受金の処理を混同する\n・過不足処理を忘れる\n\n【覚え方のコツ】\n・「仮」は一時的、「本科目」は確定\n・内容判明 = 仮払金の解消\n・借方に実際の費用、貸方に仮払金\n・複数項目は個別に振替\n\n【関連する勘定科目】\n・仮払金 → 各種費用科目\n・仮受金 → 各種収益科目\n・立替金 → 個人への請求項目\n・預り金 → 個人からの一時預かり\n\n【この問題の解き方】\n仮払金50,000円のうち、旅費交通費30,000円を本科目に振り替えます。会議費20,000円も同様に振り替える必要がありますが、問題形式上は主要項目の旅費交通費で回答します。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"仮払金振替","accounts":["旅費交通費","仮払金"],"keywords":["仮払金","本科目振替","旅費交通費","内容判明"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "雑収入として計上していた40,000円について、内容を調査した結果、受取手数料であることが判明した。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"雑収入","debit_amount":40000,"credit_account":"受取手数料","credit_amount":40000}}',
    explanation:
      "【基本概念】\n雑収入・雑損失の適正科目振替は、一時的に雑勘定に計上していた取引の内容が判明した際に、より適切で具体的な勘定科目に振り替える決算整理処理です。正確な収益・費用の分類により、財務諸表の表示を改善します。\n\n【具体例・イメージ】\n会社の経理処理をイメージしてください。内容が不明確だった収入4万円を、とりあえず雑収入で処理していました。後日調査すると、これは顧客への金融サービス仲介に対する手数料収入であることが分かりました。より具体的な受取手数料勘定に振り替えることで、収益の性質を明確にします。\n\n【仕訳パターン】\n・雑収入から本科目へ: 借方に雑収入、貸方に適切な収益科目\n・雑損失から本科目へ: 借方に適切な費用科目、貸方に雑損失\n・逆方向（本科目から雑科目へ）の場合もあり\n・複数項目の場合は個別に処理\n\n【雑勘定の性質と使用目的】\n・内容不明確な取引の一時的な処理\n・少額で重要性の低い取引\n・期末には適切な科目への振替を検討\n・財務諸表の表示科目として残すことも可能\n\n【間違えやすいポイント】\n・振替の方向（借方・貸方）を間違える\n・雑収入と雑損失を混同する\n・適切な本科目を選択できない\n・振替の必要性を判断できない\n\n【覚え方のコツ】\n・雑 → 具体的科目への振替\n・内容判明 = 科目変更のタイミング\n・借方に元の科目、貸方に新しい科目\n・収益同士、費用同士での振替\n\n【適正科目の選択基準】\n・取引の実質的な内容\n・継続性の原則\n・重要性の原則\n・業界慣行や会計基準\n\n【関連する勘定科目例】\n・雑収入 → 受取手数料、受取利息、固定資産売却益\n・雑損失 → 支払手数料、固定資産売却損、寄付金\n\n【この問題の解き方】\n雑収入40,000円の内容が受取手数料であることが判明したため、より適切な受取手数料勘定に振り替えます。これにより収益の性質が明確になり、財務分析の精度が向上します。",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"雑損益振替","accounts":["雑収入","受取手数料"],"keywords":["雑収入","受取手数料","適正科目振替","内容判明"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "決算において、建物（取得原価1,200,000円、耐用年数20年、残存価額ゼロ、直線法）の減価償却費を計上する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"減価償却費","debit_amount":60000,"credit_account":"減価償却累計額","credit_amount":60000}}',
    explanation:
      "【基本概念】\n減価償却費は、固定資産の取得原価を耐用年数にわたって費用配分する決算整理事項です。直線法では毎年一定額を費用として計上し、同額を減価償却累計額（資産の控除項目）として記録します。\n\n【計算方法（直線法）】\n減価償却費 =（取得原価 - 残存価額）÷ 耐用年数\n本問の場合：（1,200,000円 - 0円）÷ 20年 = 60,000円\n\n【仕訳の意味】\n・借方の減価償却費：当期の費用として損益計算書に計上\n・貸方の減価償却累計額：これまでの償却累計額（貸借対照表で固定資産から控除）\n\n【具体例・イメージ】\n1,200,000円の建物を20年間使用する予定です。毎年60,000円ずつ価値が減少していくと考え、その分を費用として計上します。建物の帳簿価額は毎年60,000円ずつ減少していきます。\n\n【仕訳パターン】\n・決算時：借方に減価償却費、貸方に減価償却累計額\n・翌期首：仕訳の振戻しは行わない（毎年累積）\n\n【間違えやすいポイント】\n・計算ミス（耐用年数で割り忘れ）\n・貸方を固定資産勘定で直接減額してしまう\n・定額法と定率法の混同\n・月割計算が必要な場合の処理\n\n【覚え方のコツ】\n・「減価償却費」は費用なので借方\n・「減価償却累計額」は資産の控除項目なので貸方\n・毎年同じ金額を計上（直線法の場合）\n・建物の価値は徐々に下がっていく\n\n【この問題の仕訳】\n借方：減価償却費 60,000円\n貸方：減価償却累計額 60,000円\n（建物の減価償却費を計上）",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"減価償却","accounts":["減価償却費","減価償却累計額"],"keywords":["減価償却","固定資産","決算整理","直線法"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "決算において、期首商品棚卸高150,000円、期末商品棚卸高200,000円である。売上原価を算定するための仕訳をしなさい。（期首商品の振替え）",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"仕入","debit_amount":150000,"credit_account":"繰越商品","credit_amount":150000}}',
    explanation:
      "【基本概念】\n売上原価の算定は、三分法において期首商品と期末商品を仕入勘定に振替える決算整理処理です。これにより仕入勘定が当期の売上原価を正確に表示します。「しくりくりし」の仕訳パターンで覚えましょう。\n\n【売上原価の計算式】\n売上原価 = 期首商品棚卸高 + 当期商品仕入高 - 期末商品棚卸高\n本問の場合：150,000円 + 仕入高 - 200,000円\n\n【仕訳の意味】\n・借方の仕入：期首商品を費用として計上（売上原価に反映）\n・貸方の繰越商品：前期末の商品を資産から減算（前期振替えの逆仕訳）\n\n【具体例・イメージ】\n店舗の在庫管理をイメージしてください。期首に150,000円の商品がありました。これを売るために費用（仕入）として計算し、同時に資産（繰越商品）から減らします。\n\n【仕訳パターン（「しくりくりし」）】\n1. 「し」仕入 / 繰越商品（期首商品の振替え）\n2. 「くり」繰越商品 / 仕入（期末商品の振替え）\n\n【間違えやすいポイント】\n・期首と期末の仕訳を逆にしてしまう\n・繰越商品と仕入の借貸を間違える\n・二つの仕訳を一度にしてしまう\n・「しくりくりし」の順番を間違える\n\n【覚え方のコツ】\n・「しくりくりし」＝仕入・繰越商品・繰越商品・仕入\n・期首は「仕入が借方」、期末は「繰越商品が借方」\n・売上原価は仕入勘定の最終残高に表れる\n・二つの仕訳を別々に行う（一度に一つずつ）\n\n【この問題の仕訳】\n借方：仕入 150,000円\n貸方：繰越商品 150,000円\n（期首商品棚卸高を仕入へ振替え）",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"売上原価算定","accounts":["仕入","繰越商品"],"keywords":["売上原価","棚卸","三分法","しくりくりし"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "決算において、当期の法人税等が確定し、100,000円の未払いがある。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"法人税等","debit_amount":100000,"credit_account":"未払法人税等","credit_amount":100000}}',
    explanation:
      "【基本概念】\n法人税等の確定・未払計上は、決算において当期の法人税・住民税・事業税の金額が確定した際に行う重要な決算整理処理です。発生主義に基づき、支払い時期に関係なく当期の費用として計上し、同時に未払い負債として記録します。\n\n【対象となる税金】\n・法人税：国税（所得に対する基本的な税金）\n・住民税：地方税（都道府県民税・市町村民税）\n・事業税：地方税（事業活動に対する税金）\n\n【仕訳の意味】\n・借方の法人税等：当期の税金費用として損益計算書に計上\n・貸方の未払法人税等：翌期支払予定の負債として貸借対照表に計上\n\n【具体例・イメージ】\n会社の年度決算で税理士が税額を計算し、「今年度の税金は100,000円です」と確定しました。実際の支払いは翌年度になりますが、今年度の費用として計上し、同時に「来年払う義務」として負債に記録します。\n\n【仕訳パターン】\n・決算時：借方に法人税等、貸方に未払法人税等\n・翌期支払時：借方に未払法人税等、貸方に現金\n\n【間違えやすいポイント】\n・法人税等を資産や収益で処理してしまう\n・未払法人税等を費用勘定で処理してしまう\n・中間納付分の調整を忘れる\n・源泉所得税や消費税と混同する\n\n【覚え方のコツ】\n・「法人税等」は費用なので借方\n・「未払法人税等」は負債なので貸方\n・確定したら即座に費用計上（発生主義）\n・支払いは翌期でも当期の費用\n\n【この問題の仕訳】\n借方：法人税等 100,000円\n貸方：未払法人税等 100,000円\n（当期の法人税等の確定と未払計上）",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"法人税等確定","accounts":["法人税等","未払法人税等"],"keywords":["法人税","決算","未払","税金"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "決算において、当期の消費税額が確定し、50,000円の未払いがある。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"租税公課","debit_amount":50000,"credit_account":"未払消費税","credit_amount":50000}}',
    explanation:
      "【基本概念】\n消費税の確定・未払計上は、決算において当期分の消費税額（納付税額）が確定した際に行う決算整理処理です。消費税は預った消費税から支払った消費税を差し引いた差額を国に納付する仕組みで、確定した納付税額を費用（租税公課）と未払負債として計上します。\n\n【消費税の仕組み】\n・売上時：顧客から消費税を預かる（仮受消費税）\n・仕入時：消費税を支払う（仮払消費税）\n・決算時：仮受消費税 - 仮払消費税 = 納付税額\n\n【仕訳の意味】\n・借方の租税公課：消費税納付額を当期の費用として計上\n・貸方の未払消費税：翌期納付予定の消費税を負債として計上\n\n【具体例・イメージ】\n商店が1年間営業し、顧客から預かった消費税が80,000円、仕入れで支払った消費税が30,000円でした。差額の50,000円を国に納付する義務があります。この50,000円を当期の費用として計上し、同時に「来期払う債務」として記録します。\n\n【仕訳パターン】\n・決算時：借方に租税公課、貸方に未払消費税\n・翌期納付時：借方に未払消費税、貸方に現金\n・期中は：仮受消費税・仮払消費税で処理\n\n【間違えやすいポイント】\n・仮受消費税と未払消費税を混同する\n・消費税を直接費用で処理してしまう（期中）\n・納付税額の計算ミス\n・中間納付分を考慮しない\n\n【覚え方のコツ】\n・「租税公課」は税金の費用勘定\n・「未払消費税」は具体的な負債勘定\n・期中は「仮」、決算は「確定」\n・預った税金から支払った税金を引く\n\n【この問題の仕訳】\n借方：租税公課 50,000円\n貸方：未払消費税 50,000円\n（当期分の消費税確定と未払計上）",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"消費税確定","accounts":["租税公課","未払消費税"],"keywords":["消費税","決算","未払","租税公課"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
  {
    ...
    category_id: "journal",
    question_text:
      "国庫補助金800,000円を受け取り、同額の機械装置を購入した。圧縮記帳を適用する。",
    answer_template_json:
      '{"type":"journal_entry","journalEntry":{"debit_account":"","debit_amount":0,"credit_account":"","credit_amount":0}}',
    correct_answer_json:
      '{"journalEntry":{"debit_account":"圧縮損","debit_amount":800000,"credit_account":"機械装置","credit_amount":800000}}',
    explanation:
      "【基本概念】\n圧縮記帳は、国庫補助金等を受け取って固定資産を取得した場合に、補助金相当額を固定資産の帳簿価額から減額する会計処理です。これにより、補助金収入に対する課税を繰り延べることができます。実質的に補助金の非課税効果を得る税務上の特典制度です。\n\n【処理の流れ】\n1. 補助金受取：借方 現金 / 貸方 国庫補助金\n2. 固定資産取得：借方 機械装置 / 貸方 現金\n3. 圧縮記帳：借方 圧縮損 / 貸方 機械装置\n\n【仕訳の意味】\n・借方の圧縮損：補助金相当額を特別損失として計上（税務上の損金）\n・貸方の機械装置：固定資産の帳簿価額を補助金分だけ減額\n\n【具体例・イメージ】\n工場が環境対策のため800,000円の機械を購入しました。国から同額の補助金をもらったので、実質的な負担はゼロです。しかし、補助金は本来収益なので税金がかかります。圧縮記帳により、機械の価値を下げて税負担を将来に繰り延べます。\n\n【仕訳パターン】\n・直接減額方式：借方に圧縮損、貸方に固定資産\n・積立金方式：借方に圧縮損、貸方に圧縮積立金\n・本問は直接減額方式を採用\n\n【間違えやすいポイント】\n・補助金を収益として処理してしまう\n・圧縮損を通常の損失と混同する\n・積立金方式と直接減額方式を混同する\n・減価償却への影響を考慮しない\n\n【覚え方のコツ】\n・「圧縮」＝固定資産の帳簿価額を圧縮（減額）\n・「損」だが実際の損失ではなく税務上の調整\n・補助金＝非課税にしたい＝圧縮記帳\n・取得価額は下がるが機能は変わらない\n\n【この問題の仕訳】\n借方：圧縮損 800,000円\n貸方：機械装置 800,000円\n（国庫補助金による機械装置の圧縮記帳）",
    difficulty: 3,
    tags_json:
      '{"subcategory":"adjustment","pattern":"圧縮記帳","accounts":["圧縮損","機械装置"],"keywords":["圧縮記帳","国庫補助金","固定資産","税務"],"examSection":1}',
    created_at: "2025-08-07T00:31:25.369Z",
    updated_at: "2025-08-20T08:00:00.000Z",
  },
];
