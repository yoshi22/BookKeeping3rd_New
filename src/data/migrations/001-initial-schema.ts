...
export const migration001: MigrationInfo = {
  ...
  sql: [
    ...
    `INSERT OR REPLACE INTO categories (id, name, description, sort_order, total_questions) VALUES
      ('journal', '第一問', '仕訳問題', 1, 250),
      ('ledger', '第二問', '帳簿・伝票等の問題', 2, 70),
      ('trial_balance', '第三問', '試算表作成問題', 3, 50)`,
    ...
    `INSERT OR REPLACE INTO account_items (code, name, category, question_types_json, sort_order) VALUES
      ...
      ('121', '当座借越', 'asset', '["journal", "ledger", "trial_balance"]', 11),
      ('122', '当座預金', 'asset', '["journal", "ledger", "trial_balance"]', 12),
      ('123', '普通預金', 'asset', '["journal", "ledger", "trial_balance"]', 13),
      ('124', '前払金', 'asset', '["journal", "trial_balance"]', 14),
      ('125', '未収金', 'asset', '["journal", "trial_balance"]', 15),
      ('126', '売買目的有価証券', 'asset', '["journal", "trial_balance"]', 16),
      ('127', '貸付金', 'asset', '["journal", "trial_balance"]', 17),
      ('128', '立替金', 'asset', '["journal", "trial_balance"]', 18),
      ('129', '仮払金', 'asset', '["journal", "trial_balance"]', 19),
      ('130', '現金過不足', 'asset', '["journal", "trial_balance"]', 20),
      ('131', '貸倒引当金', 'asset', '["journal", "trial_balance"]', 21),
      
      ('211', '買掛金', 'liability', '["journal", "ledger", "trial_balance"]', 31),
      ('212', '支払手形', 'liability', '["journal", "ledger", "trial_balance"]', 32),
      ('213', '借入金', 'liability', '["journal", "trial_balance"]', 33),
      ('214', '未払金', 'liability', '["journal", "trial_balance"]', 34),
      ('215', '前受金', 'liability', '["journal", "trial_balance"]', 35),
      
      ('311', '資本金', 'equity', '["journal", "trial_balance"]', 41),
      ('312', '繰越利益剰余金', 'equity', '["trial_balance"]', 42),
      
      ('411', '売上', 'revenue', '["journal", "ledger", "trial_balance"]', 51),
      ('412', '受取利息', 'revenue', '["journal", "trial_balance"]', 52),
      ('413', '雑収入', 'revenue', '["journal", "trial_balance"]', 53),
      
      ('511', '仕入', 'expense', '["journal", "ledger", "trial_balance"]', 61),
      ('512', '給料', 'expense', '["journal", "trial_balance"]', 62),
      ('513', '旅費交通費', 'expense', '["journal", "trial_balance"]', 63),
      ('514', '通信費', 'expense', '["journal", "trial_balance"]', 64),
      ('515', '水道光熱費', 'expense', '["journal", "trial_balance"]', 65),
